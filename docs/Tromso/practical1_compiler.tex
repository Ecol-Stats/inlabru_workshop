...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, frame hidden, enhanced, breakable, sharp corners, colback={codebgcolor}]}{\end{tcolorbox}}\fi
\makeatother
...
\begin{verbatim}
file:///C:/Users/admin/AppData/Local/Temp/RtmpMDHFum/filea3b857953796/widgeta3b83965482f.html screenshot completed
\end{verbatim}
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomrule=.15mm, toprule=.15mm, left=2mm, colframe=quarto-callout-note-color-frame, arc=.35mm, toptitle=1mm, breakable, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, coltitle=black, title={Task}, bottomrule=.15mm, toprule=.15mm, left=2mm, colframe=quarto-callout-warning-color-frame, arc=.35mm, toptitle=1mm, breakable, bottomtitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, titlerule=0mm, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, coltitle=black, title={Question}, bottomrule=.15mm, toprule=.15mm, left=2mm, colframe=quarto-callout-tip-color-frame, arc=.35mm, toptitle=1mm, breakable, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, colback=white]
...
\section{A spacetime model for transect survey
data}\label{a-spacetime-model-for-transect-survey-data}
...
\] The SPDE model}{
p(\textbackslash mathbf\{y\} \textbar{} \textbackslash lambda)  \textbackslash propto \textbackslash exp \textbackslash left( -\textbackslash int\_\textbackslash Omega \textbackslash lambda(\textbackslash mathbf\{s,t\}) \textbackslash mathrm\{d\}\textbackslash mathbf\{s,t\} \textbackslash right) \textbackslash prod\_\{i=1\}\^{}n \textbackslash lambda(\textbackslash mathbf\{s\}\_i,t)) 
 The SPDE model}}\label{pmathbfy-lambda-propto-exp-left--int_omega-lambdamathbfst-mathrmdmathbfst-right-prod_i1n-lambdamathbfs_it-the-spde-model}
