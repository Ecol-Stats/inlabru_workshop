...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, enhanced, breakable, frame hidden, colback={codebgcolor}, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, toptitle=1mm, titlerule=0mm, colback=white, colframe=quarto-callout-note-color-frame, rightrule=.15mm, coltitle=black, breakable, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, opacitybacktitle=0.6, arc=.35mm, opacityback=0, bottomtitle=1mm, bottomrule=.15mm, left=2mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={Task}, toptitle=1mm, titlerule=0mm, colback=white, colframe=quarto-callout-warning-color-frame, rightrule=.15mm, coltitle=black, breakable, colbacktitle=quarto-callout-warning-color!10!white, toprule=.15mm, opacitybacktitle=0.6, arc=.35mm, opacityback=0, bottomtitle=1mm, bottomrule=.15mm, left=2mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={Question}, toptitle=1mm, titlerule=0mm, colback=white, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, coltitle=black, breakable, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, opacitybacktitle=0.6, arc=.35mm, opacityback=0, bottomtitle=1mm, bottomrule=.15mm, left=2mm, leftrule=.75mm]
