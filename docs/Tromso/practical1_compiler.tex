...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, sharp corners, breakable, boxrule=0pt, frame hidden, colback={codebgcolor}]}{\end{tcolorbox}}\fi
\makeatother
...
\begin{verbatim}
file:///C:/Users/admin/AppData/Local/Temp/Rtmp8UFbUc/filee6f45f2354ca/widgete6f49f012de.html screenshot completed
\end{verbatim}
...
\subsection{The mesh}\label{the-mesh}
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, leftrule=.75mm, opacitybacktitle=0.6, title={Question}, titlerule=0mm, toptitle=1mm, bottomtitle=1mm, left=2mm, colback=white, arc=.35mm, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, bottomrule=.15mm, toprule=.15mm]
...
The mean expected number of points can be computed by integrating the
...
1 247.211 55.10701 155.8758 238.0621 365.6821 238.0621      3.650957
  mean.mc_std_err
1        6.240893
\end{verbatim}
...
\subsubsection{Model checks}\label{model-checks}
