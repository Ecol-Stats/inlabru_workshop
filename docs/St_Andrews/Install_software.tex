...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[colback={codebgcolor}, sharp corners, frame hidden, breakable, enhanced, boxrule=0pt]}{\end{tcolorbox}}\fi
\makeatother
...
\begin{verbatim}
Time used:
    Pre = 0.415, Running = 0.225, Post = 0.0546, Total = 0.695 
Fixed effects:
            mean    sd 0.025quant 0.5quant 0.975quant mode kld
(Intercept) 9.99 0.098      9.798     9.99     10.183 9.99   0

Model hyperparameters:
                                        mean    sd 0.025quant 0.5quant
Precision for the Gaussian observations 1.06 0.149      0.787     1.05
                                        0.975quant mode
Precision for the Gaussian observations       1.37 1.04

Marginal log-Likelihood:  -151.87 
 is computed 
...
Time used:
    Pre = 0.284, Running = 0.238, Post = 0.0701, Total = 0.591 
Fixed effects:
          mean    sd 0.025quant 0.5quant 0.975quant mode kld
Intercept 9.99 0.098      9.798     9.99     10.183 9.99   0
...
Marginal log-Likelihood:  -156.34 
 is computed 
Posterior summaries for the linear predictor and the fitted values are computed
(Posterior marginals needs also 'control.compute=list(return.marginals.predictor=TRUE)')
\end{verbatim}
