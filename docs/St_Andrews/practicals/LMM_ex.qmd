...
-   Fit a [linear mixed model.](#fitting_LMM)
...
In this example we are going to consider a simple linear mixed model, that is 
...
### Fitting a LMM in `inlabru`{#sec-fitting_LMM} 
