...
The SPDE approach represents the continuous Gaussian random field by a continuously indexed Gauss Markov Random Field (GMRF)
...
We call spatial Gauss Markov Random models defined on a mesh, SPDE models.
