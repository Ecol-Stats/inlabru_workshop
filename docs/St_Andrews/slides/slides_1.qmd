...
We define `linear predictor` of the mean (or a function of the mean) of our observations `given` the model components.
...
::: callout-note
We assume that, given the *linear predictor* $\eta$, the observations are independent of each other! Data dependence is expressed through the *components* of the linear predictor.
:::
