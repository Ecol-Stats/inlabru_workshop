...
format:
  revealjs:
    footer: '<a href="https://ecol-stats.github.io/inlabru_workshop/BES_workshop/docs/" style="color:#ccc; padding:20px 30px; display:inline-block; margin:-20px -30px;">Home</a>'
    margin: 0
    logo:  INLA_logo.png
...
This model cannot be implemented in the original INLA framework. `inlabru` linearizes the problem and by an iterative procedure is (*often*) able to estimate the parameters. You can read more [here](https://arxiv.org/abs/2407.00791)
...
We would be very glad if you could fill in this form and share your [feedback](https://uofg.qualtrics.com/jfe/form/SV_6nGrFQ3ploBp2dw) about the course.

![](figures/feedback-qr-code.png){fig-align="center"}
