...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, breakable, boxrule=0pt, enhanced, colback={codebgcolor}, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.3380}}
