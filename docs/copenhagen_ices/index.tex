...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.2045}}
  >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.7955}}@{}}
\toprule\noalign{}
...
13:00 - 14:30 & Lunch break 🍽️ \textbar{} \\
14:30 - 15:30 &
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.1118}}
  >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.8882}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\centering
Time
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.2022}}
  >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.7978}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\centering
Time
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.1827}}
  >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.8173}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\centering
Time
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
11:30 - 13:00 & \href{day5_practical_8.qmd}{Practical Session 8: Zero
Inflation}

\href{day5_practical_9.qmd}{Practical Session 8: Distance Sampling} \\
