...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, sharp corners, colback={codebgcolor}, breakable, boxrule=0pt, enhanced]}{\end{tcolorbox}}\fi
\makeatother
