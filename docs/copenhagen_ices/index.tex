...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, boxrule=0pt, frame hidden, colback={codebgcolor}, breakable, enhanced]}{\end{tcolorbox}}\fi
\makeatother
