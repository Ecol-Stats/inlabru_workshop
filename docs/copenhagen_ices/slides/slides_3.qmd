...
::: incremental
— A few hyperparameters $\theta\sim\pi(\theta)$ control variances, range
and so on
...
$\mathbf{y}|\mathbf{u},\theta\sim\pi(\mathbf{y}|\mathbf{u},\theta)$ of
the underlying latent Gaussian field
:::
