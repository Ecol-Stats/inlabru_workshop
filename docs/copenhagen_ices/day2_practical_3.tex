...
\begin{tcolorbox}[enhanced jigsaw, title={Task}, left=2mm, bottomtitle=1mm, breakable, arc=.35mm, colback=white, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, colframe=quarto-callout-warning-color-frame, titlerule=0mm, opacitybacktitle=0.6, opacityback=0, toprule=.15mm, coltitle=black, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={Question}, left=2mm, bottomtitle=1mm, breakable, arc=.35mm, colback=white, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, colframe=quarto-callout-tip-color-frame, titlerule=0mm, opacitybacktitle=0.6, opacityback=0, toprule=.15mm, coltitle=black, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, left=2mm, bottomtitle=1mm, breakable, arc=.35mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, opacitybacktitle=0.6, opacityback=0, toprule=.15mm, coltitle=black, toptitle=1mm, bottomrule=.15mm, leftrule=.75mm]
