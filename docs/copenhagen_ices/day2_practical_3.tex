...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, toprule=.15mm, colback=white, breakable, leftrule=.75mm, coltitle=black, opacityback=0, left=2mm, colframe=quarto-callout-warning-color-frame, arc=.35mm, titlerule=0mm, title={Task}, bottomtitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-warning-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, toprule=.15mm, colback=white, breakable, leftrule=.75mm, coltitle=black, opacityback=0, left=2mm, colframe=quarto-callout-tip-color-frame, arc=.35mm, titlerule=0mm, title={Question}, bottomtitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-tip-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, rightrule=.15mm, toprule=.15mm, colback=white, breakable, leftrule=.75mm, coltitle=black, opacityback=0, left=2mm, colframe=quarto-callout-note-color-frame, arc=.35mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomtitle=1mm, bottomrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white]
