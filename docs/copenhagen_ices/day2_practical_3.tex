...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, titlerule=0mm, breakable, opacitybacktitle=0.6, leftrule=.75mm, colframe=quarto-callout-warning-color-frame, toprule=.15mm, bottomtitle=1mm, rightrule=.15mm, coltitle=black, bottomrule=.15mm, arc=.35mm, title={Task}, colback=white, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, titlerule=0mm, breakable, opacitybacktitle=0.6, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, toprule=.15mm, bottomtitle=1mm, rightrule=.15mm, coltitle=black, bottomrule=.15mm, arc=.35mm, title={Question}, colback=white, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, titlerule=0mm, breakable, opacitybacktitle=0.6, leftrule=.75mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, bottomtitle=1mm, rightrule=.15mm, coltitle=black, bottomrule=.15mm, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colback=white, colbacktitle=quarto-callout-note-color!10!white, left=2mm, opacityback=0]
