...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title={Task}, bottomtitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, colback=white, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, breakable, opacityback=0, titlerule=0mm, colframe=quarto-callout-warning-color-frame, toptitle=1mm, toprule=.15mm, bottomrule=.15mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title={Question}, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, colback=white, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, breakable, opacityback=0, titlerule=0mm, colframe=quarto-callout-tip-color-frame, toptitle=1mm, toprule=.15mm, bottomrule=.15mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colback=white, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, breakable, opacityback=0, titlerule=0mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, toprule=.15mm, bottomrule=.15mm, arc=.35mm]
