...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-warning-color-frame, opacitybacktitle=0.6, titlerule=0mm, colbacktitle=quarto-callout-warning-color!10!white, opacityback=0, arc=.35mm, breakable, colback=white, left=2mm, leftrule=.75mm, title={Task}, coltitle=black, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, opacityback=0, arc=.35mm, breakable, colback=white, left=2mm, leftrule=.75mm, title={Question}, coltitle=black, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, arc=.35mm, breakable, colback=white, left=2mm, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, coltitle=black, rightrule=.15mm]
