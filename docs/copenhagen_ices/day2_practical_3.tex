...
\begin{tcolorbox}[enhanced jigsaw, title={Task}, bottomrule=.15mm, left=2mm, opacityback=0, colbacktitle=quarto-callout-warning-color!10!white, colback=white, coltitle=black, opacitybacktitle=0.6, rightrule=.15mm, breakable, colframe=quarto-callout-warning-color-frame, toptitle=1mm, titlerule=0mm, arc=.35mm, bottomtitle=1mm, leftrule=.75mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={Question}, bottomrule=.15mm, left=2mm, opacityback=0, colbacktitle=quarto-callout-tip-color!10!white, colback=white, coltitle=black, opacitybacktitle=0.6, rightrule=.15mm, breakable, colframe=quarto-callout-tip-color-frame, toptitle=1mm, titlerule=0mm, arc=.35mm, bottomtitle=1mm, leftrule=.75mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomrule=.15mm, left=2mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, colback=white, coltitle=black, opacitybacktitle=0.6, rightrule=.15mm, breakable, colframe=quarto-callout-note-color-frame, toptitle=1mm, titlerule=0mm, arc=.35mm, bottomtitle=1mm, leftrule=.75mm, toprule=.15mm]
