...
\begin{tcolorbox}[enhanced jigsaw, breakable, arc=.35mm, opacitybacktitle=0.6, left=2mm, toptitle=1mm, title={Question}, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, coltitle=black, colback=white, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, opacityback=0, bottomrule=.15mm, toprule=.15mm, titlerule=0mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, arc=.35mm, opacitybacktitle=0.6, left=2mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colframe=quarto-callout-note-color-frame, rightrule=.15mm, coltitle=black, colback=white, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, opacityback=0, bottomrule=.15mm, toprule=.15mm, titlerule=0mm, leftrule=.75mm]
