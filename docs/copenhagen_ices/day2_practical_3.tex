...
\textbf{Using generate to sample from the PPD}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ff }\OtherTok{=} \FunctionTok{generate}\NormalTok{(fit.ar1, }
        \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x =} \FunctionTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{150}\NormalTok{)), }
        \SpecialCharTok{\textasciitilde{}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{mean =}\NormalTok{ alpha }\SpecialCharTok{+}\NormalTok{ ut,}
                     \AttributeTok{sd =} \FunctionTok{sqrt}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\NormalTok{Precision\_for\_the\_Gaussian\_observations)),}
        \AttributeTok{n.samples =} \DecValTok{5000}\NormalTok{)}

\NormalTok{ff1 }\OtherTok{=} \FunctionTok{sapply}\NormalTok{(ff, }\ControlFlowTok{function}\NormalTok{(xx) }\FunctionTok{rnorm}\NormalTok{(}\DecValTok{150}\NormalTok{, }\AttributeTok{mean =}\NormalTok{ xx[,}\DecValTok{1}\NormalTok{], }\AttributeTok{sd =}\NormalTok{ xx[,}\DecValTok{2}\NormalTok{]))}


\NormalTok{p\_pred }\OtherTok{=} \FunctionTok{ggplot}\NormalTok{(pred\_ar1,}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{mean,}\AttributeTok{x=}\NormalTok{x))}\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{()}\SpecialCharTok{+}
    \FunctionTok{geom\_ribbon}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ x, }\AttributeTok{y =}\NormalTok{ mean, }\AttributeTok{ymin =}\NormalTok{ q0}\FloatTok{.025}\NormalTok{, }\AttributeTok{ymax =}\NormalTok{ q0}\FloatTok{.975}\NormalTok{),}
                \AttributeTok{alpha =} \FloatTok{0.5}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{y,}\AttributeTok{x=}\NormalTok{x))}
...
\NormalTok{pred\_int }\OtherTok{=} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x =} \FunctionTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{150}\NormalTok{),}
                      \AttributeTok{mean =} \FunctionTok{apply}\NormalTok{(ff1,}\DecValTok{1}\NormalTok{,mean),}
                      \AttributeTok{q1 =} \FunctionTok{apply}\NormalTok{(ff1, }\DecValTok{1}\NormalTok{, quantile,}\AttributeTok{probs =}  \FloatTok{0.025}\NormalTok{),}
                      \AttributeTok{q2 =} \FunctionTok{apply}\NormalTok{(ff1, }\DecValTok{1}\NormalTok{, quantile, }\FloatTok{0.975}\NormalTok{)}
\NormalTok{                      )}
\NormalTok{ p1 }\SpecialCharTok{+} \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{data =}\NormalTok{ pred\_int ,}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{x,}\AttributeTok{y=}\NormalTok{mean))}\SpecialCharTok{+}
   \FunctionTok{geom\_ribbon}\NormalTok{(}\AttributeTok{data =}\NormalTok{ pred\_int, }\FunctionTok{aes}\NormalTok{(x, }\AttributeTok{ymin =}\NormalTok{ q1, }\AttributeTok{ymax =}\NormalTok{ q2), }\AttributeTok{alpha =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{fill =} \StringTok{"red"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\pandocbounded{\includegraphics[keepaspectratio]{day2_practical_3_files/figure-pdf/unnamed-chunk-12-1.pdf}}

\subsection{Great Lakes water level}\label{great-lakes-water-level}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{day2_practical_3_files/figure-pdf/unnamed-chunk-15-1.pdf}}
\end{center}
...
\begin{tcolorbox}[enhanced jigsaw, title={Task}, leftrule=.75mm, toprule=.15mm, breakable, opacityback=0, left=2mm, arc=.35mm, opacitybacktitle=0.6, colback=white, rightrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, toptitle=1mm, colframe=quarto-callout-warning-color-frame, titlerule=0mm, coltitle=black, bottomrule=.15mm]
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{day2_practical_3_files/figure-pdf/unnamed-chunk-17-1.pdf}}
\end{center}

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, title={Question}, leftrule=.75mm, toprule=.15mm, breakable, opacityback=0, left=2mm, arc=.35mm, opacitybacktitle=0.6, colback=white, rightrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, toptitle=1mm, colframe=quarto-callout-tip-color-frame, titlerule=0mm, coltitle=black, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, leftrule=.75mm, toprule=.15mm, breakable, opacityback=0, left=2mm, arc=.35mm, opacitybacktitle=0.6, colback=white, rightrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, coltitle=black, bottomrule=.15mm]
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{day2_practical_3_files/figure-pdf/unnamed-chunk-19-1.pdf}}
\end{center}
...
latent effect (see (\textbf{sørbye2014?}) for further details) .
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{day2_practical_3_files/figure-pdf/unnamed-chunk-23-1.pdf}}
\end{center}
...
how temporal models can be fit to non-Gaussian data. The \texttt{Tokyo}
data set available in \texttt{INLA} contains the recorded days of rain
above 1 mm in Tokyo for 2 years, 1983:84. The data set contains the
following variables:
...
\pandocbounded{\includegraphics[keepaspectratio]{day2_practical_3_files/figure-pdf/unnamed-chunk-30-1.pdf}}
