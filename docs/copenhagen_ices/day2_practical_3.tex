...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, opacitybacktitle=0.6, left=2mm, breakable, colframe=quarto-callout-warning-color-frame, bottomrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, arc=.35mm, titlerule=0mm, title={Task}, toptitle=1mm, opacityback=0, toprule=.15mm, bottomtitle=1mm, coltitle=black, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, opacitybacktitle=0.6, left=2mm, breakable, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, leftrule=.75mm, arc=.35mm, titlerule=0mm, title={Question}, toptitle=1mm, opacityback=0, toprule=.15mm, bottomtitle=1mm, coltitle=black, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, opacitybacktitle=0.6, left=2mm, breakable, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, arc=.35mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, toptitle=1mm, opacityback=0, toprule=.15mm, bottomtitle=1mm, coltitle=black, colback=white]
