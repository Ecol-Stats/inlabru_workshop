...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-warning-color!10!white, toprule=.15mm, breakable, arc=.35mm, title={Task}, coltitle=black, bottomrule=.15mm, colback=white, colframe=quarto-callout-warning-color-frame, opacityback=0, left=2mm, titlerule=0mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, leftrule=.75mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, breakable, arc=.35mm, title={Question}, coltitle=black, bottomrule=.15mm, colback=white, colframe=quarto-callout-tip-color-frame, opacityback=0, left=2mm, titlerule=0mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, leftrule=.75mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, breakable, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, coltitle=black, bottomrule=.15mm, colback=white, colframe=quarto-callout-note-color-frame, opacityback=0, left=2mm, titlerule=0mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, leftrule=.75mm, rightrule=.15mm]
