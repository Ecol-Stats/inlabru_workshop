...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, bottomrule=.15mm, rightrule=.15mm, leftrule=.75mm, breakable, coltitle=black, title={Task}, bottomtitle=1mm, titlerule=0mm, opacityback=0, left=2mm, colbacktitle=quarto-callout-warning-color!10!white, colback=white, colframe=quarto-callout-warning-color-frame, toptitle=1mm, arc=.35mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, bottomrule=.15mm, rightrule=.15mm, leftrule=.75mm, breakable, coltitle=black, title={Question}, bottomtitle=1mm, titlerule=0mm, opacityback=0, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, colback=white, colframe=quarto-callout-tip-color-frame, toptitle=1mm, arc=.35mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, bottomrule=.15mm, rightrule=.15mm, leftrule=.75mm, breakable, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomtitle=1mm, titlerule=0mm, opacityback=0, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, colframe=quarto-callout-note-color-frame, toptitle=1mm, arc=.35mm, toprule=.15mm]
