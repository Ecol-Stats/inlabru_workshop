...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colframe=quarto-callout-warning-color-frame, title={Task}, opacityback=0, coltitle=black, opacitybacktitle=0.6, colback=white, arc=.35mm, bottomrule=.15mm, left=2mm, breakable, toptitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, bottomtitle=1mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, title={Question}, opacityback=0, coltitle=black, opacitybacktitle=0.6, colback=white, arc=.35mm, bottomrule=.15mm, left=2mm, breakable, toptitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, bottomtitle=1mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacityback=0, coltitle=black, opacitybacktitle=0.6, colback=white, arc=.35mm, bottomrule=.15mm, left=2mm, breakable, toptitle=1mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, bottomtitle=1mm, toprule=.15mm]
