...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, rightrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, breakable, title={Task}, opacityback=0, toprule=.15mm, arc=.35mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, colframe=quarto-callout-warning-color-frame, coltitle=black, bottomtitle=1mm, colback=white, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, breakable, title={Question}, opacityback=0, toprule=.15mm, arc=.35mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, colframe=quarto-callout-tip-color-frame, coltitle=black, bottomtitle=1mm, colback=white, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacityback=0, toprule=.15mm, arc=.35mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, coltitle=black, bottomtitle=1mm, colback=white, opacitybacktitle=0.6]
