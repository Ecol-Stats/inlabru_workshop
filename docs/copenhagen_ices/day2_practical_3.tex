...
\begin{tcolorbox}[enhanced jigsaw, breakable, left=2mm, title={Task}, arc=.35mm, toprule=.15mm, rightrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, toptitle=1mm, coltitle=black, titlerule=0mm, bottomrule=.15mm, leftrule=.75mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, left=2mm, title={Question}, arc=.35mm, toprule=.15mm, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, toptitle=1mm, coltitle=black, titlerule=0mm, bottomrule=.15mm, leftrule=.75mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, arc=.35mm, toprule=.15mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, colback=white, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, toptitle=1mm, coltitle=black, titlerule=0mm, bottomrule=.15mm, leftrule=.75mm, opacityback=0]
