...
\begin{tcolorbox}[enhanced jigsaw, breakable, toptitle=1mm, colback=white, bottomrule=.15mm, colframe=quarto-callout-warning-color-frame, leftrule=.75mm, titlerule=0mm, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, coltitle=black, bottomtitle=1mm, opacityback=0, arc=.35mm, toprule=.15mm, title={Task}, opacitybacktitle=0.6, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, toptitle=1mm, colback=white, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, leftrule=.75mm, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, coltitle=black, bottomtitle=1mm, opacityback=0, arc=.35mm, toprule=.15mm, title={Question}, opacitybacktitle=0.6, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, toptitle=1mm, colback=white, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, coltitle=black, bottomtitle=1mm, opacityback=0, arc=.35mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacitybacktitle=0.6, left=2mm]
