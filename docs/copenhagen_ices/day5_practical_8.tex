...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, frame hidden, colback={codebgcolor}, breakable, boxrule=0pt, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
...
\begin{verbatim}
file:///C:/Users/admin/AppData/Local/Temp/RtmpEDKJYh/filee25ccd47a70/widgete25c486e1632.html screenshot completed
\end{verbatim}
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, left=2mm, opacitybacktitle=0.6, breakable, coltitle=black, colback=white, titlerule=0mm, opacityback=0, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, arc=.35mm, toprule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={Task}, bottomtitle=1mm, colframe=quarto-callout-warning-color-frame, bottomrule=.15mm, left=2mm, opacitybacktitle=0.6, breakable, coltitle=black, colback=white, titlerule=0mm, opacityback=0, rightrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, toptitle=1mm, arc=.35mm, toprule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={Question}, bottomtitle=1mm, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, left=2mm, opacitybacktitle=0.6, breakable, coltitle=black, colback=white, titlerule=0mm, opacityback=0, rightrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, toptitle=1mm, arc=.35mm, toprule=.15mm, leftrule=.75mm]
...
1 242.6326 47.74816 165.925 236.1294 340.6208 236.1294      3.028553
  mean.mc_std_err
1        5.380526
\end{verbatim}
