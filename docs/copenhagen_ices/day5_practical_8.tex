...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, colback={codebgcolor}, breakable, boxrule=0pt, sharp corners, frame hidden]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, bottomrule=.15mm, left=2mm, colback=white, opacityback=0, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, toptitle=1mm, bottomtitle=1mm, colframe=quarto-callout-warning-color-frame, titlerule=0mm, title={Task}, rightrule=.15mm, opacitybacktitle=0.6, breakable, toprule=.15mm, arc=.35mm]
