...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colframe=quarto-callout-warning-color-frame, colbacktitle=quarto-callout-warning-color!10!white, toprule=.15mm, opacityback=0, coltitle=black, opacitybacktitle=0.6, bottomtitle=1mm, breakable, leftrule=.75mm, rightrule=.15mm, titlerule=0mm, title={Task}, arc=.35mm, toptitle=1mm, bottomrule=.15mm, colback=white]
