...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, rightrule=.15mm, opacitybacktitle=0.6, left=2mm, titlerule=0mm, breakable, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, arc=.35mm, toptitle=1mm, toprule=.15mm, leftrule=.75mm, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, title={Task}, rightrule=.15mm, opacitybacktitle=0.6, left=2mm, titlerule=0mm, breakable, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, bottomrule=.15mm, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, arc=.35mm, toptitle=1mm, toprule=.15mm, leftrule=.75mm, opacityback=0, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, title={Question}, rightrule=.15mm, opacitybacktitle=0.6, left=2mm, titlerule=0mm, breakable, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, arc=.35mm, toptitle=1mm, toprule=.15mm, leftrule=.75mm, opacityback=0, colback=white]
