...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, left=2mm, bottomtitle=1mm, rightrule=.15mm, coltitle=black, arc=.35mm, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame, toprule=.15mm, titlerule=0mm, title={Task}, colbacktitle=quarto-callout-warning-color!10!white, toptitle=1mm, breakable, bottomrule=.15mm, leftrule=.75mm, colback=white]
