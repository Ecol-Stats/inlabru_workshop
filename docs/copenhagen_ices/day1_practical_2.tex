...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colframe=quarto-callout-note-color-frame, opacityback=0, leftrule=.75mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, breakable, toprule=.15mm, toptitle=1mm, colback=white, bottomtitle=1mm, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title={Task}, colframe=quarto-callout-warning-color-frame, opacityback=0, leftrule=.75mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-warning-color!10!white, titlerule=0mm, breakable, toprule=.15mm, toptitle=1mm, colback=white, bottomtitle=1mm, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, left=2mm]
...
Time used:
    Pre = 0.297, Running = 0.29, Post = 0.149, Total = 0.736 
Fixed effects:
...
Precision for net_eff                   2.148 1.321      0.564    1.838
                                        0.975quant mode
Precision for the Gaussian observations      0.567 0.47
Precision for net_eff                        5.552 1.32
...
mean         2.1251837            0.6511220
std.dev      0.1982968            0.4155085
2.5%         1.7680828            0.1827517
50%          2.1141423            0.5434637
97.5%        2.5428094            1.7463257
\end{verbatim}
...
\begin{verbatim}
     2.5%       50%     97.5% 
0.0775818 0.2070739 0.4567844 
\end{verbatim}

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Supplementary Material}, colframe=quarto-callout-note-color-frame, opacityback=0, leftrule=.75mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, breakable, toprule=.15mm, toptitle=1mm, colback=white, bottomtitle=1mm, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, left=2mm]
...
\begin{verbatim}
           sigma_e   sigma_u  
mean       2.124765  0.6504548
sd         0.1982092 0.4158235
quant0.025 1.766088  0.1806027
quant0.25  1.985444  0.3685557
quant0.5   2.1134    0.5417868
quant0.75  2.252034  0.8076368
quant0.975 2.543966  1.752613 
\end{verbatim}
...
Time used:
    Pre = 0.28, Running = 0.227, Post = 0.0493, Total = 0.557 
Fixed effects:
              mean    sd 0.025quant 0.5quant 0.975quant   mode kld
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, colframe=quarto-callout-note-color-frame, opacityback=0, leftrule=.75mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, breakable, toprule=.15mm, toptitle=1mm, colback=white, bottomtitle=1mm, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, left=2mm]
...
Time used:
    Pre = 0.318, Running = 0.679, Post = 0.381, Total = 1.38 
Fixed effects:
         mean    sd 0.025quant 0.5quant 0.975quant   mode kld
beta_0 10.016 1.634      6.643   10.025     13.335 10.023   0
...
Precision for smooth_g                  21.221 5.505     12.500   20.517
Precision for month_reff                 0.140 0.098      0.027    0.115
                                        0.975quant   mode
Precision for the Gaussian observations      0.026  0.024
Precision for smooth_g                      34.022 19.160
Precision for month_reff                     0.393  0.072

Marginal log-Likelihood:  -2217.21 
CPO, PIT is computed 
Posterior summaries for the linear predictor and the fitted values are computed
(Posterior marginals needs also 'control.compute=list(return.marginals.predictor=TRUE)')
\end{verbatim}
