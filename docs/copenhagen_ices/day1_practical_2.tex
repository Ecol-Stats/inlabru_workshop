...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, colback=white, left=2mm, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, rightrule=.15mm, opacityback=0, coltitle=black, breakable, arc=.35mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, titlerule=0mm, colframe=quarto-callout-warning-color-frame, leftrule=.75mm, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, colback=white, left=2mm, colbacktitle=quarto-callout-warning-color!10!white, title={Task}, rightrule=.15mm, opacityback=0, coltitle=black, breakable, arc=.35mm, opacitybacktitle=0.6]
...
Time used:
    Pre = 0.251, Running = 0.226, Post = 0.114, Total = 0.591 
Fixed effects:
          mean    sd 0.025quant 0.5quant 0.975quant    mode     kld
sex_M   -1.106 0.218     -1.534   -1.106     -0.678  -1.106  11.498
beta_0 -15.816 0.870    -17.515  -15.819    -14.099 -15.819 145.189
beta_1   2.555 0.072      2.414    2.555      2.696   2.555 366.068
...
Precision for net_eff                   2.151 1.329      0.559    1.837
                                        0.975quant mode
Precision for the Gaussian observations      0.567 0.47
Precision for net_eff                        5.576 1.31

Deviance Information Criterion (DIC) ...............: 858.10
Deviance Information Criterion (DIC, saturated) ....: 247.49
...
mean         2.1250763            0.6528636
std.dev      0.1982287            0.4196940
2.5%         1.7675259            0.1819720
50%          2.1142823            0.5435848
97.5%        2.5420030            1.7602511
\end{verbatim}
...
\begin{verbatim}
      2.5%        50%      97.5% 
0.07761448 0.20438165 0.45718471 
\end{verbatim}

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, colback=white, left=2mm, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Supplementary Material}, rightrule=.15mm, opacityback=0, coltitle=black, breakable, arc=.35mm, opacitybacktitle=0.6]
...
\begin{verbatim}
           sigma_e   sigma_u  
mean       2.124657  0.6521955
sd         0.1981411 0.4200354
quant0.025 1.765527  0.1798076
quant0.25  1.985442  0.3679382
quant0.5   2.11354   0.5418893
quant0.75  2.252018  0.8097696
quant0.975 2.543154  1.766652 
\end{verbatim}
...
Time used:
    Pre = 0.249, Running = 0.179, Post = 0.0443, Total = 0.472 
Fixed effects:
              mean    sd 0.025quant 0.5quant 0.975quant   mode          kld
...
w            0.001 0.000      0.000    0.001      0.001  0.001 53888561.477
...
\begin{tcolorbox}[enhanced jigsaw, bottomrule=.15mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, colback=white, left=2mm, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, rightrule=.15mm, opacityback=0, coltitle=black, breakable, arc=.35mm, opacitybacktitle=0.6]
...
dataset was previously examined in @zuur2009 and @gillibrand2007, and
...
Time used:
    Pre = 0.252, Running = 0.416, Post = 0.123, Total = 0.791 
Fixed effects:
         mean    sd 0.025quant 0.5quant 0.975quant   mode    kld
beta_0 10.015 1.653      6.604   10.024     13.372 10.022 34.527
...
Precision for smooth_g                  21.166 5.420     12.410   20.529
Precision for month_reff                 0.141 0.104      0.027    0.114
                                        0.975quant   mode
Precision for the Gaussian observations      0.026  0.024
Precision for smooth_g                      33.602 19.335
Precision for month_reff                     0.413  0.070

Deviance Information Criterion (DIC) ...............: 5233.08
Deviance Information Criterion (DIC, saturated) ....: 826.23
Effective number of parameters .....................: 34.40

Watanabe-Akaike information criterion (WAIC) ...: 5237.82
Effective number of parameters .................: 36.93
