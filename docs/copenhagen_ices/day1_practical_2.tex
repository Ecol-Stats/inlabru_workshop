...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, coltitle=black, bottomrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, leftrule=.75mm, colback=white, opacityback=0, rightrule=.15mm, breakable, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, titlerule=0mm, arc=.35mm, toprule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-warning-color-frame, coltitle=black, bottomrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, opacitybacktitle=0.6, leftrule=.75mm, colback=white, opacityback=0, rightrule=.15mm, breakable, toptitle=1mm, title={Task}, titlerule=0mm, arc=.35mm, toprule=.15mm, left=2mm]
...
Time used:
    Pre = 0.319, Running = 0.32, Post = 0.167, Total = 0.806 
Fixed effects:
          mean    sd 0.025quant 0.5quant 0.975quant    mode kld
sex_M   -1.106 0.218     -1.534   -1.106     -0.678  -1.106   0
beta_0 -15.816 0.870    -17.515  -15.819    -14.098 -15.818   0
...
Precision for net_eff                   2.151 1.331      0.562    1.837
                                        0.975quant mode
Precision for the Gaussian observations      0.567 0.47
Precision for net_eff                        5.585 1.31
...
mean         2.1248869            0.6519130
std.dev      0.1981847            0.4171625
2.5%         1.7668324            0.1816844
50%          2.1143448            0.5438906
97.5%        2.5411518            1.7513612
\end{verbatim}
...
\begin{verbatim}
      2.5%        50%      97.5% 
0.07829506 0.20535923 0.46032566 
\end{verbatim}

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, coltitle=black, bottomrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, leftrule=.75mm, colback=white, opacityback=0, rightrule=.15mm, breakable, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Supplementary Material}, titlerule=0mm, arc=.35mm, toprule=.15mm, left=2mm]
...
\begin{verbatim}
           sigma_e   sigma_u  
mean       2.124468  0.6512453
sd         0.1980971 0.4174906
quant0.025 1.76483   0.1795292
quant0.25  1.985342  0.3681397
quant0.5   2.113602  0.5422063
quant0.75  2.251939  0.8091257
quant0.975 2.542297  1.757684 
\end{verbatim}
...
Time used:
    Pre = 0.291, Running = 0.246, Post = 0.056, Total = 0.593 
Fixed effects:
              mean    sd 0.025quant 0.5quant 0.975quant   mode kld
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, coltitle=black, bottomrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, leftrule=.75mm, colback=white, opacityback=0, rightrule=.15mm, breakable, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, titlerule=0mm, arc=.35mm, toprule=.15mm, left=2mm]
...
Time used:
    Pre = 0.319, Running = 0.592, Post = 0.355, Total = 1.27 
Fixed effects:
         mean    sd 0.025quant 0.5quant 0.975quant   mode kld
beta_0 10.017 1.621      6.679   10.025     13.304 10.023   0
...
Precision for smooth_g                  21.103 5.292     12.311   20.559
Precision for month_reff                 0.138 0.091      0.030    0.116
                                        0.975quant   mode
Precision for the Gaussian observations      0.026  0.024
Precision for smooth_g                      32.999 19.611
Precision for month_reff                     0.373  0.077

Marginal log-Likelihood:  -2217.29 
CPO, PIT is computed 
Posterior summaries for the linear predictor and the fitted values are computed
(Posterior marginals needs also 'control.compute=list(return.marginals.predictor=TRUE)')
\end{verbatim}
