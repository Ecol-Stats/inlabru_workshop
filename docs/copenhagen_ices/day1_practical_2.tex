...
\begin{tcolorbox}[enhanced jigsaw, breakable, toprule=.15mm, opacitybacktitle=0.6, rightrule=.15mm, colback=white, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, bottomrule=.15mm, arc=.35mm, bottomtitle=1mm, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, leftrule=.75mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, toprule=.15mm, opacitybacktitle=0.6, rightrule=.15mm, colback=white, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, titlerule=0mm, colframe=quarto-callout-warning-color-frame, toptitle=1mm, bottomrule=.15mm, arc=.35mm, bottomtitle=1mm, left=2mm, title={Task}, leftrule=.75mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, toprule=.15mm, opacitybacktitle=0.6, rightrule=.15mm, colback=white, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, bottomrule=.15mm, arc=.35mm, bottomtitle=1mm, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Supplementary Material}, leftrule=.75mm, opacityback=0]
