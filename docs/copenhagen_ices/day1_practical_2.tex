...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomtitle=1mm, breakable, colframe=quarto-callout-note-color-frame, arc=.35mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, titlerule=0mm, left=2mm, rightrule=.15mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomrule=.15mm, opacitybacktitle=0.6, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomtitle=1mm, breakable, colframe=quarto-callout-warning-color-frame, arc=.35mm, opacityback=0, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, toptitle=1mm, titlerule=0mm, left=2mm, rightrule=.15mm, coltitle=black, title={Task}, bottomrule=.15mm, opacitybacktitle=0.6, toprule=.15mm]
...
Time used:
    Pre = 0.326, Running = 0.339, Post = 0.188, Total = 0.853 
Fixed effects:
...
Precision for net_eff                   2.148 1.319      0.565    1.838
                                        0.975quant mode
Precision for the Gaussian observations      0.567 0.47
Precision for net_eff                        5.546 1.32
...
mean          2.125184            0.6507595
std.dev       0.198276            0.4146888
2.5%          1.768161            0.1829537
50%           2.114126            0.5433970
97.5%         2.542805            1.7436208
\end{verbatim}
...
\begin{verbatim}
      2.5%        50%      97.5% 
0.07626407 0.20394043 0.45340960 
\end{verbatim}

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomtitle=1mm, breakable, colframe=quarto-callout-note-color-frame, arc=.35mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, titlerule=0mm, left=2mm, rightrule=.15mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Supplementary Material}, bottomrule=.15mm, opacitybacktitle=0.6, toprule=.15mm]
...
\begin{verbatim}
           sigma_e   sigma_u  
mean       2.124765  0.6500926
sd         0.1981884 0.4149986
quant0.025 1.766167  0.1808078
quant0.25  1.985455  0.3686775
quant0.5   2.113383  0.5417237
quant0.75  2.252011  0.8071535
quant0.975 2.543963  1.749887 
\end{verbatim}
...
Time used:
    Pre = 0.32, Running = 0.545, Post = 0.187, Total = 1.05 
Fixed effects:
         mean    sd 0.025quant 0.5quant 0.975quant   mode kld
beta_0 10.014 1.678      6.552   10.023     13.421 10.021   0
...
Precision for smooth_g                  21.217 5.543     12.453   20.503
Precision for month_reff                 0.143 0.112      0.027    0.113
                                        0.975quant   mode
Precision for the Gaussian observations      0.026  0.024
Precision for smooth_g                      34.120 19.126
Precision for month_reff                     0.438  0.068
