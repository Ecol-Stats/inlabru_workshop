...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[colback={codebgcolor}, sharp corners, breakable, boxrule=0pt, frame hidden, enhanced]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, breakable, opacitybacktitle=0.6, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, opacityback=0, bottomtitle=1mm, coltitle=black, arc=.35mm, rightrule=.15mm, left=2mm, colback=white, toprule=.15mm, leftrule=.75mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-warning-color-frame, breakable, opacitybacktitle=0.6, toptitle=1mm, title={Task}, colbacktitle=quarto-callout-warning-color!10!white, titlerule=0mm, opacityback=0, bottomtitle=1mm, coltitle=black, arc=.35mm, rightrule=.15mm, left=2mm, colback=white, toprule=.15mm, leftrule=.75mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, breakable, opacitybacktitle=0.6, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Supplementary Material}, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, opacityback=0, bottomtitle=1mm, coltitle=black, arc=.35mm, rightrule=.15mm, left=2mm, colback=white, toprule=.15mm, leftrule=.75mm, bottomrule=.15mm]
