...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[colback={codebgcolor}, boxrule=0pt, sharp corners, frame hidden, breakable, enhanced]}{\end{tcolorbox}}\fi
\makeatother
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, breakable, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, left=2mm, bottomtitle=1mm, colback=white, arc=.35mm, toprule=.15mm, leftrule=.75mm, toptitle=1mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, titlerule=0mm, bottomrule=.15mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, breakable, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, bottomtitle=1mm, colback=white, arc=.35mm, toprule=.15mm, leftrule=.75mm, toptitle=1mm, opacityback=0, title={Task}, titlerule=0mm, bottomrule=.15mm, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame]
...
Time used:
    Pre = 0.347, Running = 0.314, Post = 0.221, Total = 0.882 
Fixed effects:
          mean    sd 0.025quant 0.5quant 0.975quant    mode kld
sex_M   -1.106 0.218     -1.534   -1.106     -0.678  -1.106   0
beta_0 -15.816 0.870    -17.517  -15.819    -14.099 -15.819   0
...
Precision for net_eff                   2.147 1.317      0.564    1.838
                                        0.975quant  mode
Precision for the Gaussian observations      0.568 0.469
Precision for net_eff                        5.539 1.320
...
mean         2.1246774            0.6510942
std.dev      0.1981316            0.4157026
2.5%         1.7654688            0.1831857
50%          2.1146753            0.5431763
97.5%        2.5396010            1.7472435
\end{verbatim}
...
\begin{verbatim}
      2.5%        50%      97.5% 
0.07868891 0.20641342 0.45305839 
\end{verbatim}

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, breakable, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, left=2mm, bottomtitle=1mm, colback=white, arc=.35mm, toprule=.15mm, leftrule=.75mm, toptitle=1mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Supplementary Material}, titlerule=0mm, bottomrule=.15mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame]
...
\begin{verbatim}
           sigma_e  sigma_u  
mean       2.124258 0.6504271
sd         0.198044 0.4160173
quant0.025 1.763458 0.1810363
quant0.25  1.985293 0.3685988
quant0.5   2.113933 0.5414986
quant0.75  2.251994 0.8072665
quant0.975 2.540734 1.753543 
\end{verbatim}
...
Time used:
    Pre = 0.369, Running = 0.717, Post = 0.177, Total = 1.26 
Fixed effects:
         mean    sd 0.025quant 0.5quant 0.975quant   mode kld
beta_0 10.016 1.632      6.655   10.025     13.327 10.023   0
...
Precision for smooth_g                  21.124 5.356     12.313   20.546
Precision for month_reff                 0.139 0.094      0.030    0.116
                                        0.975quant   mode
Precision for the Gaussian observations      0.026  0.023
Precision for smooth_g                      33.250 19.510
Precision for month_reff                     0.383  0.076

Marginal log-Likelihood:  -2217.26 
 is computed 
Posterior summaries for the linear predictor and the fitted values are computed
(Posterior marginals needs also 'control.compute=list(return.marginals.predictor=TRUE)')
\end{verbatim}
