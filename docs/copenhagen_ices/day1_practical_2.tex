...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, arc=.35mm, opacitybacktitle=0.6, opacityback=0, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, breakable, titlerule=0mm, toprule=.15mm, toptitle=1mm, left=2mm, coltitle=black, leftrule=.75mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-warning-color!10!white, bottomrule=.15mm, arc=.35mm, opacitybacktitle=0.6, opacityback=0, colback=white, title={Task}, bottomtitle=1mm, colframe=quarto-callout-warning-color-frame, breakable, titlerule=0mm, toprule=.15mm, toptitle=1mm, left=2mm, coltitle=black, leftrule=.75mm, rightrule=.15mm]
...
Time used:
    Pre = 0.474, Running = 0.393, Post = 0.257, Total = 1.12 
Fixed effects:
...
Precision for net_eff                   2.148 1.318      0.564    1.838
                                        0.975quant  mode
Precision for the Gaussian observations      0.568 0.469
Precision for net_eff                        5.542 1.319
...
mean         2.1246599            0.6511010
std.dev      0.1981148            0.4156762
2.5%         1.7654485            0.1830589
50%          2.1146728            0.5432414
97.5%        2.5395155            1.7470746
\end{verbatim}
...
\begin{verbatim}
      2.5%        50%      97.5% 
0.07892222 0.20317708 0.46135531 
\end{verbatim}

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, arc=.35mm, opacitybacktitle=0.6, opacityback=0, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Supplementary Material}, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, breakable, titlerule=0mm, toprule=.15mm, toptitle=1mm, left=2mm, coltitle=black, leftrule=.75mm, rightrule=.15mm]
...
\begin{verbatim}
           sigma_e   sigma_u  
mean       2.124241  0.6504339
sd         0.1980272 0.4159911
quant0.025 1.763438  0.1809095
quant0.25  1.985291  0.3685736
quant0.5   2.11393   0.5415638
quant0.75  2.251973  0.8073643
quant0.975 2.540648  1.753371 
\end{verbatim}
...
Time used:
    Pre = 0.42, Running = 0.697, Post = 0.181, Total = 1.3 
Fixed effects:
         mean    sd 0.025quant 0.5quant 0.975quant   mode kld
beta_0 10.016 1.636      6.638   10.025     13.339 10.023   0
...
Precision for smooth_g                  21.222 5.548     12.414   20.520
Precision for month_reff                 0.140 0.099      0.027    0.115
                                        0.975quant   mode
Precision for the Gaussian observations      0.026  0.024
Precision for smooth_g                      34.100 19.174
Precision for month_reff                     0.395  0.071
