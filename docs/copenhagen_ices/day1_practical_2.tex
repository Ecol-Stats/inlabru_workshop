...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, breakable, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, coltitle=black, rightrule=.15mm, colback=white, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, arc=.35mm, bottomtitle=1mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colbacktitle=quarto-callout-warning-color!10!white, breakable, titlerule=0mm, title={Task}, coltitle=black, rightrule=.15mm, colback=white, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame, bottomrule=.15mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, arc=.35mm, bottomtitle=1mm, left=2mm]
...
Time used:
    Pre = 0.323, Running = 0.293, Post = 0.218, Total = 0.834 
Fixed effects:
...
Precision for net_eff                   2.145 1.312      0.562    1.839
                                        0.975quant mode
Precision for the Gaussian observations      0.567 0.47
Precision for net_eff                        5.518 1.32
...
mean         2.1251137            0.6516507
std.dev      0.1982475            0.4172313
2.5%         1.7674637            0.1838441
50%          2.1143470            0.5428131
97.5%        2.5420159            1.7529186
\end{verbatim}
...
\begin{verbatim}
      2.5%        50%      97.5% 
0.07743354 0.20456838 0.46701249 
\end{verbatim}

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, breakable, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Supplementary Material}, coltitle=black, rightrule=.15mm, colback=white, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, arc=.35mm, bottomtitle=1mm, left=2mm]
...
\begin{verbatim}
           sigma_e   sigma_u  
mean       2.124695  0.6509834
sd         0.1981598 0.4175519
quant0.025 1.765464  0.1816892
quant0.25  1.985473  0.3686155
quant0.5   2.113604  0.5411288
quant0.75  2.252083  0.8073278
quant0.975 2.543166  1.759271 
\end{verbatim}
...
Time used:
    Pre = 0.346, Running = 0.696, Post = 0.188, Total = 1.23 
Fixed effects:
         mean    sd 0.025quant 0.5quant 0.975quant   mode kld
beta_0 10.016 1.629      6.656   10.025     13.323 10.023   0
...
Precision for smooth_g                  21.178 5.412     12.463   20.533
Precision for month_reff                 0.139 0.096      0.028    0.115
                                        0.975quant   mode
Precision for the Gaussian observations      0.026  0.024
Precision for smooth_g                      33.623 19.315
Precision for month_reff                     0.387  0.073
