...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, breakable, coltitle=black, opacitybacktitle=0.6, titlerule=0mm, bottomrule=.15mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, leftrule=.75mm, rightrule=.15mm, opacityback=0, bottomtitle=1mm, colback=white, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, breakable, coltitle=black, opacitybacktitle=0.6, titlerule=0mm, bottomrule=.15mm, toptitle=1mm, colframe=quarto-callout-warning-color-frame, toprule=.15mm, leftrule=.75mm, rightrule=.15mm, opacityback=0, bottomtitle=1mm, colback=white, arc=.35mm, title={Task}, colbacktitle=quarto-callout-warning-color!10!white]
...
Time used:
    Pre = 0.306, Running = 0.302, Post = 0.21, Total = 0.818 
Fixed effects:
          mean    sd 0.025quant 0.5quant 0.975quant    mode kld
sex_M   -1.106 0.218     -1.534   -1.106     -0.678  -1.106   0
beta_0 -15.816 0.870    -17.515  -15.819    -14.099 -15.818   0
...
Precision for net_eff                   2.152 1.335      0.559    1.836
                                        0.975quant mode
Precision for the Gaussian observations      0.567 0.47
Precision for net_eff                        5.596 1.31
...
mean         2.1252168            0.6532105
std.dev      0.1983279            0.4203081
2.5%         1.7682373            0.1813399
50%          2.1140984            0.5438882
97.5%        2.5430794            1.7619858
\end{verbatim}
...
\begin{verbatim}
      2.5%        50%      97.5% 
0.07742287 0.20602194 0.45108069 
\end{verbatim}

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, left=2mm, breakable, coltitle=black, opacitybacktitle=0.6, titlerule=0mm, bottomrule=.15mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, toprule=.15mm, leftrule=.75mm, rightrule=.15mm, opacityback=0, bottomtitle=1mm, colback=white, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Supplementary Material}, colbacktitle=quarto-callout-note-color!10!white]
...
\begin{verbatim}
           sigma_e   sigma_u  
mean       2.124798  0.6525422
sd         0.1982402 0.4206554
quant0.025 1.766243  0.1791731
quant0.25  1.985437  0.3677457
quant0.5   2.113355  0.5421899
quant0.75  2.252045  0.8105566
quant0.975 2.544238  1.768397 
\end{verbatim}
...
Time used:
    Pre = 0.328, Running = 0.536, Post = 0.186, Total = 1.05 
Fixed effects:
         mean    sd 0.025quant 0.5quant 0.975quant   mode kld
beta_0 10.015 1.665      6.579   10.024     13.395 10.022   0
...
Precision for smooth_g                  21.207 5.552     12.377   20.509
Precision for month_reff                 0.142 0.108      0.026    0.113
                                        0.975quant   mode
Precision for the Gaussian observations      0.026  0.024
Precision for smooth_g                      34.077 19.178
Precision for month_reff                     0.427  0.068

Marginal log-Likelihood:  -2217.15 
 is computed 
Posterior summaries for the linear predictor and the fitted values are computed
(Posterior marginals needs also 'control.compute=list(return.marginals.predictor=TRUE)')
\end{verbatim}
