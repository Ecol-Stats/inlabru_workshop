...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colframe=quarto-callout-warning-color-frame, opacityback=0, breakable, arc=.35mm, rightrule=.15mm, colback=white, titlerule=0mm, opacitybacktitle=0.6, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, toprule=.15mm, toptitle=1mm, title={Task}]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colframe=quarto-callout-tip-color-frame, opacityback=0, breakable, arc=.35mm, rightrule=.15mm, colback=white, titlerule=0mm, opacitybacktitle=0.6, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, toprule=.15mm, toptitle=1mm, title={Question}]
...
\subsection{Adding a spatial
covariate}\label{adding-a-spatial-covariate}

Finally, we want to add a covariate to the model. We are going to check
if the PM10 levels influence the numbers of hospitalizations.

\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colframe=quarto-callout-warning-color-frame, opacityback=0, breakable, arc=.35mm, rightrule=.15mm, colback=white, titlerule=0mm, opacitybacktitle=0.6, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, toprule=.15mm, toptitle=1mm, title={Task}]

Add the effect of PM10 in the previous model. First as a linear effect
and then as a smooth effect (RW2). Check the results.

Take hint

To use the RW2 model you first need to group the values of the PM10
using the \texttt{inla.group()} function.
...
\NormalTok{cmp }\OtherTok{=} \ErrorTok{\textasciitilde{}} \FunctionTok{Intercept}\NormalTok{(}\DecValTok{1}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{space}\NormalTok{(space, }\AttributeTok{model =} \StringTok{"besag"}\NormalTok{, }\AttributeTok{graph =}\NormalTok{ Q) }\SpecialCharTok{+} \FunctionTok{iid}\NormalTok{(space, }\AttributeTok{model =} \StringTok{"iid"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{cov}\NormalTok{(pm10, }\AttributeTok{model =} \StringTok{"linear"}\NormalTok{)}

\NormalTok{formula }\OtherTok{=}\NormalTok{ observed }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Intercept }\SpecialCharTok{+}\NormalTok{ space }\SpecialCharTok{+}\NormalTok{ iid }\SpecialCharTok{+}\NormalTok{ cov}
...
\NormalTok{fit\_lin }\OtherTok{=} \FunctionTok{bru}\NormalTok{(cmp, lik)}
\CommentTok{\# effect of the covaraite}
\CommentTok{\# fit\_lin$summary.fixed}

\DocumentationTok{\#\# Linear Effect}
\NormalTok{resp\_cases}\SpecialCharTok{$}\NormalTok{pm10\_group}\OtherTok{=}  \FunctionTok{inla.group}\NormalTok{(resp\_cases}\SpecialCharTok{$}\NormalTok{pm10)}
\NormalTok{cmp }\OtherTok{=} \ErrorTok{\textasciitilde{}} \FunctionTok{Intercept}\NormalTok{(}\DecValTok{1}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{space}\NormalTok{(space, }\AttributeTok{model =} \StringTok{"besag"}\NormalTok{, }\AttributeTok{graph =}\NormalTok{ Q) }\SpecialCharTok{+} \FunctionTok{iid}\NormalTok{(space, }\AttributeTok{model =} \StringTok{"iid"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{cov}\NormalTok{(pm10\_group, }\AttributeTok{model =} \StringTok{"rw2"}\NormalTok{)}
...
\NormalTok{fit\_smooth }\OtherTok{=} \FunctionTok{bru}\NormalTok{(cmp, lik)}

\CommentTok{\#check the smooth effect of the covariate}
\CommentTok{\#fit\_smooth$summary.random$cov \%\textgreater{}\% ggplot() + geom\_line(aes(ID,mean)) +}
\CommentTok{\#  geom\_ribbon(aes(ID, ymin =\textasciigrave{}0.025quant\textasciigrave{}, ymax = \textasciigrave{}0.975quant\textasciigrave{}), alpha = 0.5)}
\end{Highlighting}
\end{Shaded}
...
Intercept -6.6032448 0.10132506 -6.8018382 -6.6032448 -6.4046513 -6.6032448   0
elev       0.6619757 0.06814916  0.5284058  0.6619757  0.7955456  0.6619757   0
\end{verbatim}

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colframe=quarto-callout-warning-color-frame, opacityback=0, breakable, arc=.35mm, rightrule=.15mm, colback=white, titlerule=0mm, opacitybacktitle=0.6, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, toprule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}]
...
Intercept  -6.6032448 0.10132506 -6.8018382 -6.6032448 -6.4046513 -6.6032448
elev        0.6619757 0.06814916  0.5284058  0.6619757  0.7955456  0.6619757
Intercept1 -6.7885952 0.11532231 -7.0146228 -6.7885952 -6.5625676 -6.7885952
elev1       1.0771720 0.09304001  0.8948169  1.0771720  1.2595270  1.0771720
           kld
Intercept    0
elev         0
Intercept1   0
...
\pandocbounded{\includegraphics[keepaspectratio]{day3_practical_5_files/figure-pdf/unnamed-chunk-103-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{day3_practical_5_files/figure-pdf/unnamed-chunk-104-1.pdf}}
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colframe=quarto-callout-note-color-frame, opacityback=0, breakable, arc=.35mm, rightrule=.15mm, colback=white, titlerule=0mm, opacitybacktitle=0.6, leftrule=.75mm, bottomtitle=1mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, toprule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}]
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{day3_practical_5_files/figure-pdf/unnamed-chunk-109-1.pdf}}
\end{center}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{day3_practical_5_files/figure-pdf/unnamed-chunk-109-2.pdf}}
\end{center}
...
\pandocbounded{\includegraphics[keepaspectratio]{day3_practical_5_files/figure-pdf/unnamed-chunk-110-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{day3_practical_5_files/figure-pdf/unnamed-chunk-110-2.pdf}}
