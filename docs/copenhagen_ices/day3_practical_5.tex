...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, sharp corners, frame hidden, colback={codebgcolor}, breakable, enhanced]}{\end{tcolorbox}}\fi
\makeatother
...
\FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} 
  ...
  \FunctionTok{scale\_fill\_scico}\NormalTok{(}\AttributeTok{direction =} \SpecialCharTok{{-}}\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Getting prediction
...
\subsection{Geostatistics}\label{sec-linmodel}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{data =} \FunctionTok{dens\_prior\_range}\NormalTok{(}\DecValTok{1}\NormalTok{,.}\DecValTok{5}\NormalTok{), }\FunctionTok{aes}\NormalTok{(x,y, }\AttributeTok{color =} \StringTok{"model1"}\NormalTok{)) }\SpecialCharTok{+}
...
\FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} 
  \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{data =}\NormalTok{ fit1}\SpecialCharTok{$}\NormalTok{marginals.hyperpar}\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{Range for space}\StringTok{\textasciigrave{}}\NormalTok{, }\FunctionTok{aes}\NormalTok{(x,y, }\AttributeTok{color =} \StringTok{"Posterior"}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{data =} \FunctionTok{dens\_prior\_range}\NormalTok{(}\DecValTok{100}\NormalTok{,.}\DecValTok{5}\NormalTok{), }\FunctionTok{aes}\NormalTok{(x,y, }\AttributeTok{color =} \StringTok{"Prior"}\NormalTok{))}


\FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} 
  \FunctionTok{geom\_line}\NormalTok{(}\AttributeTok{data =}\NormalTok{ fit1}\SpecialCharTok{$}\NormalTok{marginals.hyperpar}\SpecialCharTok{$}\StringTok{\textasciigrave{}}\AttributeTok{Stdev for space}\StringTok{\textasciigrave{}}\NormalTok{, }\FunctionTok{aes}\NormalTok{(x,y, }\AttributeTok{color =} \StringTok{"Posterior"}\NormalTok{)) }\SpecialCharTok{+}
...
\subsubsection{An alternative model}\label{an-alternative-model}
...
\NormalTok{fit3}\SpecialCharTok{$}\NormalTok{summary.random}\SpecialCharTok{$}\NormalTok{covariate }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(ID,mean)) }\SpecialCharTok{+} 
...
\subsection{Log-Gaussian Cox
Processes}\label{log-gaussian-cox-processes}
...
the whole space so our liner predictor is\\
\[
...
\] Where \(N_k\) is the number of integration points
\(s_1,\dots,s_{N_k}\) and \(w_1,\dots,w_{N_k}\) are the integration
weights.
...
Remember that in the \texttt{inlabru} framework we model the log
intensity \(\eta = log(\lambda)\)
...
\section{Inhomogeneous Poisson Process}\label{NHPP}
...
\NormalTok{preds2}\SpecialCharTok{$}\NormalTok{lin\_scale }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{geom\_sf}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{color =}\NormalTok{ mean)) }\SpecialCharTok{+} \FunctionTok{scale\_color\_scico}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Lam\_samps2 }\OtherTok{=} \FunctionTok{generate}\NormalTok{(fit2, ips, }\SpecialCharTok{\textasciitilde{}} \FunctionTok{sum}\NormalTok{(weight }\SpecialCharTok{*} \FunctionTok{exp}\NormalTok{(elev }\SpecialCharTok{+}\NormalTok{ Intercept)),}
                    \AttributeTok{n.samples =} \DecValTok{2000}\NormalTok{)}



\NormalTok{Lam\_df }\OtherTok{=} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{Lam =} \FunctionTok{as.numeric}\NormalTok{(Lam\_samps2))}

\FunctionTok{ggplot}\NormalTok{(Lam\_df) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Lam),}
...
\pandocbounded{\includegraphics[keepaspectratio]{day3_practical_5_files/figure-pdf/unnamed-chunk-94-1.pdf}}

\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomtitle=1mm, arc=.35mm, titlerule=0mm, opacityback=0, rightrule=.15mm, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, coltitle=black, left=2mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, toprule=.15mm, opacitybacktitle=0.6, leftrule=.75mm]

\end{tcolorbox}

\section{Log-Gaussian Cox Process}\label{log-gaussian-cox-process}
...
\pandocbounded{\includegraphics[keepaspectratio]{day3_practical_5_files/figure-pdf/unnamed-chunk-95-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{day3_practical_5_files/figure-pdf/unnamed-chunk-95-2.pdf}}
...
\NormalTok{Lam\_samps3 }\OtherTok{=} \FunctionTok{generate}\NormalTok{(fit3, ips, }\SpecialCharTok{\textasciitilde{}} \FunctionTok{sum}\NormalTok{(weight }\SpecialCharTok{*} \FunctionTok{exp}\NormalTok{(space }\SpecialCharTok{+}\NormalTok{ Intercept }\SpecialCharTok{+}\NormalTok{ elev)),}
                    \AttributeTok{n.samples =} \DecValTok{2000}\NormalTok{)}
...
\NormalTok{Lam\_df3 }\OtherTok{=} \FunctionTok{data.frame}\NormalTok{(}
  \AttributeTok{Lam =} \FunctionTok{as.numeric}\NormalTok{(Lam\_samps3))}

\FunctionTok{ggplot}\NormalTok{(Lam\_df3) }\SpecialCharTok{+}
  \FunctionTok{geom\_histogram}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Lam),}
                 \AttributeTok{colour =} \StringTok{"blue"}\NormalTok{,}
                 \AttributeTok{alpha =} \FloatTok{0.5}\NormalTok{,}
                 \AttributeTok{bins =} \DecValTok{20}\NormalTok{) }\SpecialCharTok{+}
...
\pandocbounded{\includegraphics[keepaspectratio]{day3_practical_5_files/figure-pdf/unnamed-chunk-95-3.pdf}}
