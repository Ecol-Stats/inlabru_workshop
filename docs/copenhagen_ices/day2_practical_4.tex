...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, bottomrule=.15mm, opacityback=0, toprule=.15mm, colframe=quarto-callout-warning-color-frame, colback=white, breakable, toptitle=1mm, arc=.35mm, left=2mm, opacitybacktitle=0.6, title={Task}, colbacktitle=quarto-callout-warning-color!10!white, bottomtitle=1mm, titlerule=0mm, coltitle=black, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, bottomrule=.15mm, opacityback=0, toprule=.15mm, colframe=quarto-callout-tip-color-frame, colback=white, breakable, toptitle=1mm, arc=.35mm, left=2mm, opacitybacktitle=0.6, title={Question}, colbacktitle=quarto-callout-tip-color!10!white, bottomtitle=1mm, titlerule=0mm, coltitle=black, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, bottomrule=.15mm, opacityback=0, toprule=.15mm, colframe=quarto-callout-note-color-frame, colback=white, breakable, toptitle=1mm, arc=.35mm, left=2mm, opacitybacktitle=0.6, title={Example}, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, titlerule=0mm, coltitle=black, rightrule=.15mm]
