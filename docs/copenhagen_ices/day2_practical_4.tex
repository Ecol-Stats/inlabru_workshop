...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, opacityback=0, colback=white, leftrule=.75mm, colbacktitle=quarto-callout-warning-color!10!white, breakable, toptitle=1mm, title={Task}, bottomtitle=1mm, rightrule=.15mm, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, left=2mm]
