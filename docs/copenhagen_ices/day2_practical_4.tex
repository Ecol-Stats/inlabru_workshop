...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, breakable, colbacktitle=quarto-callout-warning-color!10!white, colback=white, leftrule=.75mm, opacitybacktitle=0.6, left=2mm, toptitle=1mm, titlerule=0mm, colframe=quarto-callout-warning-color-frame, title={Task}, arc=.35mm, coltitle=black, rightrule=.15mm, bottomrule=.15mm, opacityback=0, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, breakable, colbacktitle=quarto-callout-tip-color!10!white, colback=white, leftrule=.75mm, opacitybacktitle=0.6, left=2mm, toptitle=1mm, titlerule=0mm, colframe=quarto-callout-tip-color-frame, title={Question}, arc=.35mm, coltitle=black, rightrule=.15mm, bottomrule=.15mm, opacityback=0, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, breakable, colbacktitle=quarto-callout-note-color!10!white, colback=white, leftrule=.75mm, opacitybacktitle=0.6, left=2mm, toptitle=1mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, title={Example}, arc=.35mm, coltitle=black, rightrule=.15mm, bottomrule=.15mm, opacityback=0, toprule=.15mm]
