...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, sharp corners, boxrule=0pt, breakable, enhanced, colback={codebgcolor}]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, left=2mm, titlerule=0mm, toptitle=1mm, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, colback=white, leftrule=.75mm, opacityback=0, title={Task}, colbacktitle=quarto-callout-warning-color!10!white, opacitybacktitle=0.6, coltitle=black, toprule=.15mm, bottomrule=.15mm, rightrule=.15mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, left=2mm, titlerule=0mm, toptitle=1mm, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, colback=white, leftrule=.75mm, opacityback=0, title={Question}, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6, coltitle=black, toprule=.15mm, bottomrule=.15mm, rightrule=.15mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, left=2mm, titlerule=0mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, colback=white, leftrule=.75mm, opacityback=0, title={Example}, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, coltitle=black, toprule=.15mm, bottomrule=.15mm, rightrule=.15mm, arc=.35mm]
