...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, leftrule=.75mm, left=2mm, toptitle=1mm, arc=.35mm, breakable, coltitle=black, bottomtitle=1mm, titlerule=0mm, title={Task}, bottomrule=.15mm, opacitybacktitle=0.6, colback=white, opacityback=0, colframe=quarto-callout-warning-color-frame]
