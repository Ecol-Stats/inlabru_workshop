...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, opacitybacktitle=0.6, leftrule=.75mm, opacityback=0, arc=.35mm, colbacktitle=quarto-callout-warning-color!10!white, colframe=quarto-callout-warning-color-frame, colback=white, titlerule=0mm, coltitle=black, toptitle=1mm, bottomtitle=1mm, breakable, rightrule=.15mm, title={Task}, bottomrule=.15mm, left=2mm]
