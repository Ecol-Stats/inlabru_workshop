...
\begin{tcolorbox}[enhanced jigsaw, colback=white, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, breakable, bottomtitle=1mm, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, opacityback=0, toptitle=1mm, titlerule=0mm, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, toprule=.15mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, breakable, bottomtitle=1mm, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, opacityback=0, toptitle=1mm, titlerule=0mm, left=2mm, title={Task}, toprule=.15mm, colframe=quarto-callout-warning-color-frame, opacitybacktitle=0.6]
