...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toprule=.15mm, opacitybacktitle=0.6, opacityback=0, left=2mm, breakable, colframe=quarto-callout-note-color-frame, leftrule=.75mm, toptitle=1mm, arc=.35mm, rightrule=.15mm, titlerule=0mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, bottomrule=.15mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toprule=.15mm, opacitybacktitle=0.6, opacityback=0, left=2mm, breakable, colframe=quarto-callout-warning-color-frame, leftrule=.75mm, toptitle=1mm, arc=.35mm, rightrule=.15mm, titlerule=0mm, bottomtitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, title={Task}, bottomrule=.15mm, coltitle=black]
