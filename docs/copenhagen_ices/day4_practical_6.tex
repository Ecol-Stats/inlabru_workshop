...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, toptitle=1mm, colback=white, leftrule=.75mm, opacitybacktitle=0.6, toprule=.15mm, left=2mm, titlerule=0mm, colframe=quarto-callout-warning-color-frame, breakable, coltitle=black, title={Task}, rightrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, bottomrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, colback=white, leftrule=.75mm, opacitybacktitle=0.6, toprule=.15mm, left=2mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, breakable, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, rightrule=.15mm, opacityback=0]
