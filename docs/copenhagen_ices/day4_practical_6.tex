...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, bottomrule=.15mm, coltitle=black, leftrule=.75mm, toprule=.15mm, arc=.35mm, opacityback=0, colframe=quarto-callout-note-color-frame, breakable, colback=white, titlerule=0mm, left=2mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, title={Task}, bottomrule=.15mm, coltitle=black, leftrule=.75mm, toprule=.15mm, arc=.35mm, opacityback=0, colframe=quarto-callout-warning-color-frame, breakable, colback=white, titlerule=0mm, left=2mm, toptitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, opacitybacktitle=0.6]
