...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, breakable, sharp corners, enhanced, boxrule=0pt, colback={codebgcolor}]}{\end{tcolorbox}}\fi
\makeatother
...
Time used:
    Pre = 0.34, Running = 0.282, Post = 0.0658, Total = 0.687 
Fixed effects:
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, toprule=.15mm, colback=white, coltitle=black, bottomrule=.15mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, titlerule=0mm, left=2mm, rightrule=.15mm, arc=.35mm, opacitybacktitle=0.6, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, breakable, title={Task}, toprule=.15mm, colback=white, coltitle=black, bottomrule=.15mm, toptitle=1mm, colframe=quarto-callout-warning-color-frame, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, titlerule=0mm, left=2mm, rightrule=.15mm, arc=.35mm, opacitybacktitle=0.6, opacityback=0]
