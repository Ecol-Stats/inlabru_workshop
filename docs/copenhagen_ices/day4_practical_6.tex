...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[colback={codebgcolor}, sharp corners, enhanced, boxrule=0pt, breakable, frame hidden]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
Time used:
    Pre = 0.937, Running = 0.196, Post = 0.00719, Total = 1.14 
Fixed effects:
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, breakable, coltitle=black, left=2mm, opacityback=0, bottomtitle=1mm, titlerule=0mm, toptitle=1mm, colback=white, leftrule=.75mm, toprule=.15mm, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colbacktitle=quarto-callout-warning-color!10!white, colframe=quarto-callout-warning-color-frame, breakable, coltitle=black, left=2mm, opacityback=0, bottomtitle=1mm, titlerule=0mm, toptitle=1mm, colback=white, leftrule=.75mm, toprule=.15mm, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, title={Task}]
