...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[colback={codebgcolor}, breakable, frame hidden, sharp corners, enhanced, boxrule=0pt]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, left=2mm, coltitle=black, opacitybacktitle=0.6, titlerule=0mm, toprule=.15mm, bottomtitle=1mm, title={Task}, opacityback=0, colback=white, rightrule=.15mm, colframe=quarto-callout-warning-color-frame, leftrule=.75mm, bottomrule=.15mm, arc=.35mm, toptitle=1mm, colbacktitle=quarto-callout-warning-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, left=2mm, coltitle=black, opacitybacktitle=0.6, titlerule=0mm, toprule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacityback=0, colback=white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, bottomrule=.15mm, arc=.35mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, left=2mm, coltitle=black, opacitybacktitle=0.6, titlerule=0mm, toprule=.15mm, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, opacityback=0, colback=white, rightrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, bottomrule=.15mm, arc=.35mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white]
