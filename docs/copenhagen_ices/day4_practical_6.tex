...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacityback=0, colframe=quarto-callout-note-color-frame, toptitle=1mm, opacitybacktitle=0.6, breakable, rightrule=.15mm, colback=white, titlerule=0mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, bottomrule=.15mm, left=2mm, bottomtitle=1mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacityback=0, colframe=quarto-callout-warning-color-frame, toptitle=1mm, opacitybacktitle=0.6, breakable, rightrule=.15mm, colback=white, titlerule=0mm, coltitle=black, title={Task}, colbacktitle=quarto-callout-warning-color!10!white, arc=.35mm, bottomrule=.15mm, left=2mm, bottomtitle=1mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, opacityback=0, colframe=quarto-callout-note-color-frame, toptitle=1mm, opacitybacktitle=0.6, breakable, rightrule=.15mm, colback=white, titlerule=0mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, bottomrule=.15mm, left=2mm, bottomtitle=1mm, toprule=.15mm]
