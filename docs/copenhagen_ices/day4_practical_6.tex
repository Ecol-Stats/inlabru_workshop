...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, left=2mm, toptitle=1mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, breakable, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, coltitle=black, arc=.35mm, colback=white, rightrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame, title={Task}, left=2mm, toptitle=1mm, leftrule=.75mm, colbacktitle=quarto-callout-warning-color!10!white, bottomtitle=1mm, breakable, titlerule=0mm, bottomrule=.15mm, toprule=.15mm, coltitle=black, arc=.35mm, colback=white, rightrule=.15mm, opacityback=0]
