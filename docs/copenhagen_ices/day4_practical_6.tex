...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, breakable, sharp corners, enhanced, frame hidden, colback={codebgcolor}]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, breakable, rightrule=.15mm, colback=white, toprule=.15mm, coltitle=black, bottomrule=.15mm, bottomtitle=1mm, toptitle=1mm, title={Task}, colframe=quarto-callout-warning-color-frame, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, titlerule=0mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, breakable, rightrule=.15mm, colback=white, toprule=.15mm, coltitle=black, bottomrule=.15mm, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colframe=quarto-callout-note-color-frame, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, titlerule=0mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, breakable, rightrule=.15mm, colback=white, toprule=.15mm, coltitle=black, bottomrule=.15mm, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, colframe=quarto-callout-note-color-frame, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, titlerule=0mm, arc=.35mm]
