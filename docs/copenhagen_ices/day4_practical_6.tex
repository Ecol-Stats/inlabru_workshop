...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, boxrule=0pt, colback={codebgcolor}, frame hidden, sharp corners, breakable]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-warning-color!10!white, colframe=quarto-callout-warning-color-frame, toprule=.15mm, opacitybacktitle=0.6, coltitle=black, rightrule=.15mm, titlerule=0mm, toptitle=1mm, breakable, title={Task}, arc=.35mm, bottomtitle=1mm, opacityback=0, leftrule=.75mm, bottomrule=.15mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, toprule=.15mm, opacitybacktitle=0.6, coltitle=black, rightrule=.15mm, titlerule=0mm, toptitle=1mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, arc=.35mm, bottomtitle=1mm, opacityback=0, leftrule=.75mm, bottomrule=.15mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, toprule=.15mm, opacitybacktitle=0.6, coltitle=black, rightrule=.15mm, titlerule=0mm, toptitle=1mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, arc=.35mm, bottomtitle=1mm, opacityback=0, leftrule=.75mm, bottomrule=.15mm, colback=white]
