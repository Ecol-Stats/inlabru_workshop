...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, toptitle=1mm, opacityback=0, bottomtitle=1mm, colback=white, rightrule=.15mm, breakable, arc=.35mm, opacitybacktitle=0.6, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, toprule=.15mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, titlerule=0mm, colframe=quarto-callout-warning-color-frame, bottomrule=.15mm, toptitle=1mm, opacityback=0, bottomtitle=1mm, colback=white, rightrule=.15mm, breakable, arc=.35mm, opacitybacktitle=0.6, leftrule=.75mm, colbacktitle=quarto-callout-warning-color!10!white, title={Task}, toprule=.15mm, coltitle=black]
