...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, breakable, colback={codebgcolor}, enhanced, frame hidden, boxrule=0pt]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
\begin{tcolorbox}[enhanced jigsaw, title={Task}, leftrule=.75mm, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, titlerule=0mm, colback=white, breakable, bottomtitle=1mm, bottomrule=.15mm, opacityback=0, colframe=quarto-callout-warning-color-frame, arc=.35mm, opacitybacktitle=0.6, toptitle=1mm, left=2mm, toprule=.15mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, titlerule=0mm, colback=white, breakable, bottomtitle=1mm, bottomrule=.15mm, opacityback=0, colframe=quarto-callout-note-color-frame, arc=.35mm, opacitybacktitle=0.6, toptitle=1mm, left=2mm, toprule=.15mm, coltitle=black]
...
Time used:
    Pre = 0.852, Running = 0.187, Post = 0.00791, Total = 1.05 
Fixed effects:
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, titlerule=0mm, colback=white, breakable, bottomtitle=1mm, bottomrule=.15mm, opacityback=0, colframe=quarto-callout-note-color-frame, arc=.35mm, opacitybacktitle=0.6, toptitle=1mm, left=2mm, toprule=.15mm, coltitle=black]
