...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, opacitybacktitle=0.6, breakable, opacityback=0, bottomrule=.15mm, arc=.35mm, colback=white, colframe=quarto-callout-warning-color-frame, rightrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, toptitle=1mm, titlerule=0mm, left=2mm, toprule=.15mm, coltitle=black, title={Task}]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, opacitybacktitle=0.6, breakable, opacityback=0, bottomrule=.15mm, arc=.35mm, colback=white, colframe=quarto-callout-note-color-frame, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, toptitle=1mm, titlerule=0mm, left=2mm, toprule=.15mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}]
