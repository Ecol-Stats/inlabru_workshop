...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, frame hidden, breakable, sharp corners, colback={codebgcolor}, enhanced]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, toprule=.15mm, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, colback=white, titlerule=0mm, colbacktitle=quarto-callout-warning-color!10!white, bottomrule=.15mm, breakable, title={Task}, rightrule=.15mm, bottomtitle=1mm, arc=.35mm, colframe=quarto-callout-warning-color-frame, coltitle=black, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, toprule=.15mm, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, colback=white, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, rightrule=.15mm, bottomtitle=1mm, arc=.35mm, colframe=quarto-callout-note-color-frame, coltitle=black, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, toprule=.15mm, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, colback=white, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, rightrule=.15mm, bottomtitle=1mm, arc=.35mm, colframe=quarto-callout-note-color-frame, coltitle=black, opacityback=0]
