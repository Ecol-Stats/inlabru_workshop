...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, arc=.35mm, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, colback=white, titlerule=0mm, coltitle=black, left=2mm, opacityback=0, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Posterior predictive model checking}, bottomrule=.15mm, opacitybacktitle=0.6, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, arc=.35mm, leftrule=.75mm, colbacktitle=quarto-callout-warning-color!10!white, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, colframe=quarto-callout-warning-color-frame, colback=white, titlerule=0mm, coltitle=black, left=2mm, opacityback=0, title={Task}, bottomrule=.15mm, opacitybacktitle=0.6, breakable]
