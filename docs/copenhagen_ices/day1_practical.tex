...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, enhanced, breakable, boxrule=0pt, colback={codebgcolor}, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
\ifLuaTeX
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, arc=.35mm, title={Question}, opacityback=0, left=2mm, bottomrule=.15mm, leftrule=.75mm, toprule=.15mm, coltitle=black, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, toptitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, colback=white, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacityback=0, left=2mm, bottomrule=.15mm, leftrule=.75mm, toprule=.15mm, coltitle=black, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, breakable]
...
\DocumentationTok{\#\#     Pre = 0.473, Running = 0.206, Post = 0.0979, Total = 0.777 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#            mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
\DocumentationTok{\#\# Intercept 1.990 0.009      1.973    1.990      2.007 1.990   0}
\DocumentationTok{\#\# beta\_1    0.502 0.009      0.484    0.502      0.520 0.502   0}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Model hyperparameters:}
\DocumentationTok{\#\#                                           mean    sd 0.025quant 0.5quant}
\DocumentationTok{\#\# Precision for the Gaussian observations 142.37 20.13     105.71   141.43}
\DocumentationTok{\#\#                                         0.975quant   mode}
\DocumentationTok{\#\# Precision for the Gaussian observations     184.49 139.53}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Deviance Information Criterion (DIC) ...............: {-}206.09}
\DocumentationTok{\#\# Deviance Information Criterion (DIC, saturated) ....: 105.36}
\DocumentationTok{\#\# Effective number of parameters .....................: 2.99}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Watanabe{-}Akaike information criterion (WAIC) ...: {-}205.90}
\DocumentationTok{\#\# Effective number of parameters .................: 3.07}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Marginal log{-}Likelihood:  83.68 }
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-warning-color-frame, opacitybacktitle=0.6, arc=.35mm, title={Task}, opacityback=0, left=2mm, bottomrule=.15mm, leftrule=.75mm, toprule=.15mm, coltitle=black, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, toptitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, colback=white, breakable]
...
\tightlist
\item
  Understand the structure of a Linear Mixed Model (LLM) as a Latent
  Gaussian Model (LGM)
\item
  Simulate data from a LMM
\item
  Learn how to fit a LMM with \texttt{inlabru} and visualize the fitted
  values.
\end{itemize}
...
\DocumentationTok{\#\# Time used:}
\DocumentationTok{\#\#     Pre = 0.296, Running = 0.29, Post = 0.135, Total = 0.72 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#            mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
\DocumentationTok{\#\# Intercept 2.108 0.438      1.228    2.108      2.987 2.108   0}
...
\subsubsection{\texorpdfstring{\textbf{Visualize the fitted
values}}{Visualize the fitted values}}\label{visualize-the-fitted-values}

The fitted values of the model can be accessed through
\texttt{model\$summary.fitted}. Notice that the first entries correspond
to the \(n\) observation associated with the linear predictor. We can
then plot the fitted values as follows:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fit}\SpecialCharTok{$}\NormalTok{summary.fitted.values[}\DecValTok{1}\SpecialCharTok{:}\DecValTok{100}\NormalTok{,] }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{j =}\NormalTok{df}\SpecialCharTok{$}\NormalTok{j,}\AttributeTok{x =}\NormalTok{df}\SpecialCharTok{$}\NormalTok{x) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{x,}\AttributeTok{y=}\NormalTok{mean,}\AttributeTok{color=}\FunctionTok{factor}\NormalTok{(j)))}\SpecialCharTok{+}\FunctionTok{geom\_line}\NormalTok{()}\SpecialCharTok{+}\FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{x,}\AttributeTok{y=}\NormalTok{y,}\AttributeTok{colour=}\FunctionTok{factor}\NormalTok{(j)))}\SpecialCharTok{+}\FunctionTok{facet\_wrap}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{j)}
\end{Highlighting}
\end{Shaded}
...
Time used:
    Pre = 0.268, Running = 0.171, Post = 0.0321, Total = 0.471 
Fixed effects:
...
{\centering \includegraphics{day1_practical_files/figure-pdf/unnamed-chunk-68-1.pdf}
