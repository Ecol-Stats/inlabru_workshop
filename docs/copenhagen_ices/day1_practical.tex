...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, frame hidden, sharp corners, breakable, colback={codebgcolor}, enhanced]}{\end{tcolorbox}}\fi
\makeatother
\ifLuaTeX
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, breakable, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, colback=white, colframe=quarto-callout-tip-color-frame, leftrule=.75mm, coltitle=black, bottomrule=.15mm, opacitybacktitle=0.6, title={Question}, rightrule=.15mm, opacityback=0, bottomtitle=1mm, titlerule=0mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, colframe=quarto-callout-note-color-frame, leftrule=.75mm, coltitle=black, bottomrule=.15mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, rightrule=.15mm, opacityback=0, bottomtitle=1mm, titlerule=0mm, arc=.35mm]
...
\DocumentationTok{\#\#     Pre = 0.41, Running = 0.19, Post = 0.0749, Total = 0.675 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean   sd 0.025quant 0.5quant 0.975quant  mode       kld}
\DocumentationTok{\#\# beta\_0 2.014 0.01      1.994    2.014      2.033 2.014 13064.702}
\DocumentationTok{\#\# beta\_1 0.496 0.01      0.476    0.496      0.515 0.496  3211.403}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Model hyperparameters:}
\DocumentationTok{\#\#                                           mean    sd 0.025quant 0.5quant}
\DocumentationTok{\#\# Precision for the Gaussian observations 105.12 14.87      78.05   104.42}
\DocumentationTok{\#\#                                         0.975quant   mode}
\DocumentationTok{\#\# Precision for the Gaussian observations     136.22 103.02}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Deviance Information Criterion (DIC) ...............: {-}175.75}
\DocumentationTok{\#\# Deviance Information Criterion (DIC, saturated) ....: 105.37}
\DocumentationTok{\#\# Effective number of parameters .....................: 2.99}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Watanabe{-}Akaike information criterion (WAIC) ...: {-}175.97}
\DocumentationTok{\#\# Effective number of parameters .................: 2.69}
\DocumentationTok{\#\# }
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, breakable, left=2mm, colbacktitle=quarto-callout-warning-color!10!white, toprule=.15mm, colback=white, colframe=quarto-callout-warning-color-frame, leftrule=.75mm, coltitle=black, bottomrule=.15mm, opacitybacktitle=0.6, title={Task}, rightrule=.15mm, opacityback=0, bottomtitle=1mm, titlerule=0mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, colback=white, colframe=quarto-callout-note-color-frame, leftrule=.75mm, coltitle=black, bottomrule=.15mm, opacitybacktitle=0.6, title={Supplementary material: LMM as a LGM}, rightrule=.15mm, opacityback=0, bottomtitle=1mm, titlerule=0mm, arc=.35mm]
...
\DocumentationTok{\#\# Time used:}
\DocumentationTok{\#\#     Pre = 0.269, Running = 0.262, Post = 0.123, Total = 0.654 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode    kld}
...
Time used:
    Pre = 0.239, Running = 0.196, Post = 0.0419, Total = 0.477 
Fixed effects:
...
\begin{verbatim}
            mean         sd 0.025quant 0.5quant 0.975quant    mode      kld
Intercept 1.2988 0.06506724   1.171641 1.298566   1.427294 1.29857 158.5814
\end{verbatim}
