...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, left=2mm, leftrule=.75mm, opacityback=0, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, colback=white, bottomtitle=1mm, breakable, bottomrule=.15mm, toptitle=1mm, titlerule=0mm, title={Question}, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, left=2mm, leftrule=.75mm, opacityback=0, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, colback=white, bottomtitle=1mm, breakable, bottomrule=.15mm, toptitle=1mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, rightrule=.15mm]
...
\DocumentationTok{\#\#     Pre = 0.377, Running = 0.238, Post = 0.11, Total = 0.725 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean   sd 0.025quant 0.5quant 0.975quant  mode kld}
\DocumentationTok{\#\# beta\_0 1.995 0.01      1.975    1.995      2.014 1.995   0}
\DocumentationTok{\#\# beta\_1 0.508 0.01      0.488    0.508      0.528 0.508   0}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Model hyperparameters:}
\DocumentationTok{\#\#                                           mean    sd 0.025quant 0.5quant}
\DocumentationTok{\#\# Precision for the Gaussian observations 104.00 14.71      77.22   103.31}
\DocumentationTok{\#\#                                         0.975quant   mode}
\DocumentationTok{\#\# Precision for the Gaussian observations     134.77 101.92}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Marginal log{-}Likelihood:  67.89 }
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, toprule=.15mm, left=2mm, leftrule=.75mm, opacityback=0, colframe=quarto-callout-warning-color-frame, opacitybacktitle=0.6, colback=white, bottomtitle=1mm, breakable, bottomrule=.15mm, toptitle=1mm, titlerule=0mm, title={Task}, rightrule=.15mm]
...
\DocumentationTok{\#\# Time used:}
\DocumentationTok{\#\#     Pre = 0.32, Running = 0.276, Post = 0.119, Total = 0.715 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
...
Time used:
    Pre = 0.257, Running = 0.201, Post = 0.0379, Total = 0.496 
Fixed effects:
...
Intercept 1.298799 0.06506723    1.17164 1.298565   1.427294 1.298569
                  kld
Intercept 9.96571e-09
\end{verbatim}
