...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, breakable, leftrule=.75mm, left=2mm, coltitle=black, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, title={Question}, titlerule=0mm, toptitle=1mm, opacitybacktitle=0.6, opacityback=0, bottomtitle=1mm, rightrule=.15mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, breakable, leftrule=.75mm, left=2mm, coltitle=black, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, titlerule=0mm, toptitle=1mm, opacitybacktitle=0.6, opacityback=0, bottomtitle=1mm, rightrule=.15mm, colback=white]
...
\DocumentationTok{\#\#     Pre = 0.384, Running = 0.238, Post = 0.128, Total = 0.75 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
\DocumentationTok{\#\# beta\_0 1.993 0.009      1.975    1.993      2.011 1.993   0}
\DocumentationTok{\#\# beta\_1 0.492 0.009      0.474    0.492      0.510 0.492   0}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Model hyperparameters:}
\DocumentationTok{\#\#                                           mean    sd 0.025quant 0.5quant}
\DocumentationTok{\#\# Precision for the Gaussian observations 121.37 17.16      90.12   120.56}
\DocumentationTok{\#\#                                         0.975quant   mode}
\DocumentationTok{\#\# Precision for the Gaussian observations     157.28 118.95}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Marginal log{-}Likelihood:  75.61 }
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, breakable, leftrule=.75mm, left=2mm, coltitle=black, arc=.35mm, colbacktitle=quarto-callout-warning-color!10!white, colframe=quarto-callout-warning-color-frame, bottomrule=.15mm, title={Task}, titlerule=0mm, toptitle=1mm, opacitybacktitle=0.6, opacityback=0, bottomtitle=1mm, rightrule=.15mm, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, breakable, leftrule=.75mm, left=2mm, coltitle=black, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, title={Supplementary material: LMM as a LGM}, titlerule=0mm, toptitle=1mm, opacitybacktitle=0.6, opacityback=0, bottomtitle=1mm, rightrule=.15mm, colback=white]
...
\DocumentationTok{\#\# Time used:}
\DocumentationTok{\#\#     Pre = 0.329, Running = 0.278, Post = 0.139, Total = 0.745 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
...
Time used:
    Pre = 0.261, Running = 0.252, Post = 0.0465, Total = 0.56 
Fixed effects:
