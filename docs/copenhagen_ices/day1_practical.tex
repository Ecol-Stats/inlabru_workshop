...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, frame hidden, enhanced, colback={codebgcolor}, boxrule=0pt, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, coltitle=black, bottomrule=.15mm, breakable, colback=white, leftrule=.75mm, opacitybacktitle=0.6, title={Question}, bottomtitle=1mm, toprule=.15mm, opacityback=0, colframe=quarto-callout-tip-color-frame, titlerule=0mm, toptitle=1mm, arc=.35mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, left=2mm, coltitle=black, bottomrule=.15mm, breakable, colback=white, leftrule=.75mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomtitle=1mm, toprule=.15mm, opacityback=0, colframe=quarto-callout-note-color-frame, titlerule=0mm, toptitle=1mm, arc=.35mm, rightrule=.15mm]
...
\DocumentationTok{\#\#     Pre = 0.375, Running = 0.251, Post = 0.0973, Total = 0.723 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
\DocumentationTok{\#\# beta\_0 2.013 0.009      1.995    2.013      2.031 2.013   0}
\DocumentationTok{\#\# beta\_1 0.496 0.010      0.477    0.496      0.515 0.496   0}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Model hyperparameters:}
\DocumentationTok{\#\#                                           mean    sd 0.025quant 0.5quant}
\DocumentationTok{\#\# Precision for the Gaussian observations 128.65 18.19      95.52   127.80}
\DocumentationTok{\#\#                                         0.975quant   mode}
\DocumentationTok{\#\# Precision for the Gaussian observations     166.71 126.08}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Marginal log{-}Likelihood:  78.58 }
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, coltitle=black, bottomrule=.15mm, breakable, colback=white, leftrule=.75mm, opacitybacktitle=0.6, title={Task}, bottomtitle=1mm, toprule=.15mm, opacityback=0, colframe=quarto-callout-warning-color-frame, titlerule=0mm, toptitle=1mm, arc=.35mm, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, left=2mm, coltitle=black, bottomrule=.15mm, breakable, colback=white, leftrule=.75mm, opacitybacktitle=0.6, title={Supplementary material: LMM as a LGM}, bottomtitle=1mm, toprule=.15mm, opacityback=0, colframe=quarto-callout-note-color-frame, titlerule=0mm, toptitle=1mm, arc=.35mm, rightrule=.15mm]
...
\DocumentationTok{\#\# Time used:}
\DocumentationTok{\#\#     Pre = 0.313, Running = 0.26, Post = 0.145, Total = 0.719 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
...
Time used:
    Pre = 0.251, Running = 0.212, Post = 0.0418, Total = 0.505 
Fixed effects:
