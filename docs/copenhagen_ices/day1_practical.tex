...
\begin{tcolorbox}[enhanced jigsaw, breakable, coltitle=black, leftrule=.75mm, titlerule=0mm, opacityback=0, rightrule=.15mm, arc=.35mm, toprule=.15mm, opacitybacktitle=0.6, left=2mm, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, title={Question}, toptitle=1mm, bottomrule=.15mm, colback=white, colframe=quarto-callout-tip-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, coltitle=black, leftrule=.75mm, titlerule=0mm, opacityback=0, rightrule=.15mm, arc=.35mm, toprule=.15mm, opacitybacktitle=0.6, left=2mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, toptitle=1mm, bottomrule=.15mm, colback=white, colframe=quarto-callout-note-color-frame]
...
\DocumentationTok{\#\#     Pre = 0.374, Running = 0.231, Post = 0.103, Total = 0.708 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean   sd 0.025quant 0.5quant 0.975quant  mode kld}
\DocumentationTok{\#\# beta\_0 2.027 0.01      2.007    2.027      2.046 2.027   0}
\DocumentationTok{\#\# beta\_1 0.523 0.01      0.503    0.523      0.544 0.523   0}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Model hyperparameters:}
\DocumentationTok{\#\#                                           mean    sd 0.025quant 0.5quant}
\DocumentationTok{\#\# Precision for the Gaussian observations 103.32 14.61      76.71   102.63}
\DocumentationTok{\#\#                                         0.975quant   mode}
\DocumentationTok{\#\# Precision for the Gaussian observations     133.88 101.26}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Marginal log{-}Likelihood:  67.59 }
...
\begin{tcolorbox}[enhanced jigsaw, breakable, coltitle=black, leftrule=.75mm, titlerule=0mm, opacityback=0, rightrule=.15mm, arc=.35mm, toprule=.15mm, opacitybacktitle=0.6, left=2mm, bottomtitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, title={Task}, toptitle=1mm, bottomrule=.15mm, colback=white, colframe=quarto-callout-warning-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, coltitle=black, leftrule=.75mm, titlerule=0mm, opacityback=0, rightrule=.15mm, arc=.35mm, toprule=.15mm, opacitybacktitle=0.6, left=2mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, title={Supplementary material: LMM as a LGM}, toptitle=1mm, bottomrule=.15mm, colback=white, colframe=quarto-callout-note-color-frame]
...
\DocumentationTok{\#\# Time used:}
\DocumentationTok{\#\#     Pre = 0.313, Running = 0.283, Post = 0.13, Total = 0.726 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
...
Time used:
    Pre = 0.252, Running = 0.212, Post = 0.0389, Total = 0.503 
Fixed effects:
