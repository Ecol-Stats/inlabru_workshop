...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, enhanced, frame hidden, breakable, colback={codebgcolor}, boxrule=0pt]}{\end{tcolorbox}}\fi
\makeatother
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, arc=.35mm, rightrule=.15mm, colback=white, coltitle=black, bottomtitle=1mm, titlerule=0mm, toptitle=1mm, title={Question}, opacitybacktitle=0.6, opacityback=0, colframe=quarto-callout-tip-color-frame, toprule=.15mm, breakable, colbacktitle=quarto-callout-tip-color!10!white, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, arc=.35mm, rightrule=.15mm, colback=white, coltitle=black, bottomtitle=1mm, titlerule=0mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacitybacktitle=0.6, opacityback=0, colframe=quarto-callout-note-color-frame, toprule=.15mm, breakable, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm]
...
\DocumentationTok{\#\#     Pre = 0.373, Running = 0.247, Post = 0.111, Total = 0.731 }
...
\DocumentationTok{\#\# beta\_1 0.520 0.01      0.500    0.520      0.540 0.520   0}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Model hyperparameters:}
\DocumentationTok{\#\#                                          mean    sd 0.025quant 0.5quant}
\DocumentationTok{\#\# Precision for the Gaussian observations 98.67 13.95      73.26    98.01}
\DocumentationTok{\#\#                                         0.975quant  mode}
\DocumentationTok{\#\# Precision for the Gaussian observations     127.86 96.70}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Marginal log{-}Likelihood:  65.25 }
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, arc=.35mm, rightrule=.15mm, colback=white, coltitle=black, bottomtitle=1mm, titlerule=0mm, toptitle=1mm, title={Task}, opacitybacktitle=0.6, opacityback=0, colframe=quarto-callout-warning-color-frame, toprule=.15mm, breakable, colbacktitle=quarto-callout-warning-color!10!white, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, leftrule=.75mm, arc=.35mm, rightrule=.15mm, colback=white, coltitle=black, bottomtitle=1mm, titlerule=0mm, toptitle=1mm, title={Supplementary material: LMM as a LGM}, opacitybacktitle=0.6, opacityback=0, colframe=quarto-callout-note-color-frame, toprule=.15mm, breakable, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm]
...
\DocumentationTok{\#\# Time used:}
\DocumentationTok{\#\#     Pre = 0.325, Running = 0.253, Post = 0.273, Total = 0.851 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
...
Time used:
    Pre = 0.253, Running = 0.204, Post = 0.0406, Total = 0.498 
Fixed effects:
