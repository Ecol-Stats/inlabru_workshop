...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, frame hidden, boxrule=0pt, colback={codebgcolor}, breakable, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, arc=.35mm, opacityback=0, titlerule=0mm, colback=white, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, breakable, leftrule=.75mm, left=2mm, coltitle=black, opacitybacktitle=0.6, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, bottomrule=.15mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={Task}, arc=.35mm, opacityback=0, titlerule=0mm, colback=white, rightrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, breakable, leftrule=.75mm, left=2mm, coltitle=black, opacitybacktitle=0.6, bottomtitle=1mm, colframe=quarto-callout-warning-color-frame, toptitle=1mm, bottomrule=.15mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, title={Supplementary material: LMM as a LGM}, arc=.35mm, opacityback=0, titlerule=0mm, colback=white, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, breakable, leftrule=.75mm, left=2mm, coltitle=black, opacitybacktitle=0.6, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, bottomrule=.15mm, toprule=.15mm]
