...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, rightrule=.15mm, coltitle=black, toprule=.15mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacitybacktitle=0.6, colback=white, bottomrule=.15mm, breakable, opacityback=0, leftrule=.75mm, toptitle=1mm, titlerule=0mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, rightrule=.15mm, coltitle=black, toprule=.15mm, colframe=quarto-callout-warning-color-frame, left=2mm, colbacktitle=quarto-callout-warning-color!10!white, title={Task}, opacitybacktitle=0.6, colback=white, bottomrule=.15mm, breakable, opacityback=0, leftrule=.75mm, toptitle=1mm, titlerule=0mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, rightrule=.15mm, coltitle=black, toprule=.15mm, colframe=quarto-callout-note-color-frame, left=2mm, colbacktitle=quarto-callout-note-color!10!white, title={Supplementary material: LMM as a LGM}, opacitybacktitle=0.6, colback=white, bottomrule=.15mm, breakable, opacityback=0, leftrule=.75mm, toptitle=1mm, titlerule=0mm, arc=.35mm]
