...
\section{Linear Model}\label{sec-linmodel}
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, leftrule=.75mm, colback=white, arc=.35mm, breakable, bottomtitle=1mm, coltitle=black, toprule=.15mm, titlerule=0mm, opacityback=0, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, title={Question}, opacitybacktitle=0.6, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, colback=white, arc=.35mm, breakable, bottomtitle=1mm, coltitle=black, toprule=.15mm, titlerule=0mm, opacityback=0, colframe=quarto-callout-note-color-frame, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacitybacktitle=0.6, left=2mm]
...
\subsection{\texorpdfstring{Fitting a linear regression model with
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, bottomrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, colback=white, arc=.35mm, breakable, bottomtitle=1mm, coltitle=black, toprule=.15mm, titlerule=0mm, opacityback=0, colframe=quarto-callout-warning-color-frame, rightrule=.15mm, title={Task}, opacitybacktitle=0.6, left=2mm]
...
\DocumentationTok{\#\#     Pre = 1.06, Running = 0.187, Post = 0.0177, Total = 1.27 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
\DocumentationTok{\#\# beta\_0 1.996 0.011      1.974    1.996      2.017 1.996   0}
\DocumentationTok{\#\# beta\_1 0.508 0.011      0.487    0.508      0.529 0.508   0}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Model hyperparameters:}
\DocumentationTok{\#\#                                          mean    sd 0.025quant 0.5quant}
\DocumentationTok{\#\# Precision for the Gaussian observations 84.21 11.91      62.52    83.65}
\DocumentationTok{\#\#                                         0.975quant  mode}
\DocumentationTok{\#\# Precision for the Gaussian observations     109.12 82.53}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Marginal log{-}Likelihood:  57.29 }
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, colback=white, arc=.35mm, breakable, bottomtitle=1mm, coltitle=black, toprule=.15mm, titlerule=0mm, opacityback=0, colframe=quarto-callout-note-color-frame, rightrule=.15mm, title={Supplementary material: LMM as a LGM}, opacitybacktitle=0.6, left=2mm]
...
\subsection{\texorpdfstring{\textbf{Simulate example
...
\subsection{\texorpdfstring{Fitting a LMM in
...
\DocumentationTok{\#\# Time used:}
\DocumentationTok{\#\#     Pre = 0.931, Running = 0.193, Post = 0.0353, Total = 1.16 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
...
while specifying the model components.
...
\section{Generalized Linear Model}\label{sec-genlinmodel}
...
\subsection{\texorpdfstring{Fitting a GLM in
...
Time used:
    Pre = 0.865, Running = 0.191, Post = 0.00585, Total = 1.06 
Fixed effects:
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{day1_practical_files/figure-pdf/unnamed-chunk-50-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{day1_practical_files/figure-pdf/unnamed-chunk-53-1.pdf}}
