...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, opacityback=0, left=2mm, bottomtitle=1mm, coltitle=black, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, breakable, title={Question}, colback=white, colframe=quarto-callout-tip-color-frame, toptitle=1mm, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, opacityback=0, left=2mm, bottomtitle=1mm, coltitle=black, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colback=white, colframe=quarto-callout-note-color-frame, toptitle=1mm, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, leftrule=.75mm]
...
\DocumentationTok{\#\#     Pre = 0.522, Running = 0.565, Post = 0.0795, Total = 1.17 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#            mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
\DocumentationTok{\#\# Intercept 2.015 0.009      1.997    2.015      2.033 2.015   0}
\DocumentationTok{\#\# beta\_1    0.493 0.010      0.473    0.493      0.512 0.493   0}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Model hyperparameters:}
\DocumentationTok{\#\#                                           mean    sd 0.025quant 0.5quant}
\DocumentationTok{\#\# Precision for the Gaussian observations 117.08 16.56      86.93   116.31}
\DocumentationTok{\#\#                                         0.975quant   mode}
\DocumentationTok{\#\# Precision for the Gaussian observations     151.72 114.75}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Deviance Information Criterion (DIC) ...............: {-}186.53}
\DocumentationTok{\#\# Deviance Information Criterion (DIC, saturated) ....: 105.38}
\DocumentationTok{\#\# Effective number of parameters .....................: 3.00}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Watanabe{-}Akaike information criterion (WAIC) ...: {-}186.35}
\DocumentationTok{\#\# Effective number of parameters .................: 3.04}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Marginal log{-}Likelihood:  73.87 }
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, opacityback=0, left=2mm, bottomtitle=1mm, coltitle=black, arc=.35mm, colbacktitle=quarto-callout-warning-color!10!white, breakable, title={Task}, colback=white, colframe=quarto-callout-warning-color-frame, toptitle=1mm, bottomrule=.15mm, titlerule=0mm, rightrule=.15mm, toprule=.15mm, leftrule=.75mm]
...
\DocumentationTok{\#\# Time used:}
\DocumentationTok{\#\#     Pre = 0.292, Running = 0.252, Post = 0.129, Total = 0.673 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#            mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
\DocumentationTok{\#\# Intercept 2.108 0.438      1.229    2.108      2.987 2.108   0}
...
\DocumentationTok{\#\# Precision for u                         1.614 1.062      0.369    1.356}
\DocumentationTok{\#\#                                         0.975quant  mode}
...
Time used:
    Pre = 0.238, Running = 0.2, Post = 0.0348, Total = 0.473 
Fixed effects:
