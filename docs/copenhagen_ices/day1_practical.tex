...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toprule=.15mm, opacityback=0, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, breakable, left=2mm, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, titlerule=0mm, title={Question}, arc=.35mm, bottomrule=.15mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toprule=.15mm, opacityback=0, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, breakable, left=2mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, arc=.35mm, bottomrule=.15mm, coltitle=black]
...
\DocumentationTok{\#\#     Pre = 0.471, Running = 0.213, Post = 0.0783, Total = 0.762 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
\DocumentationTok{\#\# beta\_0 1.999 0.011      1.978    1.999      2.020 1.999   0}
\DocumentationTok{\#\# beta\_1 0.506 0.011      0.485    0.506      0.527 0.506   0}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Model hyperparameters:}
\DocumentationTok{\#\#                                          mean    sd 0.025quant 0.5quant}
\DocumentationTok{\#\# Precision for the Gaussian observations 92.47 13.08      68.66    91.86}
\DocumentationTok{\#\#                                         0.975quant  mode}
\DocumentationTok{\#\# Precision for the Gaussian observations     119.83 90.63}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Deviance Information Criterion (DIC) ...............: {-}162.93}
\DocumentationTok{\#\# Deviance Information Criterion (DIC, saturated) ....: 105.36}
\DocumentationTok{\#\# Effective number of parameters .....................: 2.99}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Watanabe{-}Akaike information criterion (WAIC) ...: {-}162.81}
\DocumentationTok{\#\# Effective number of parameters .................: 3.01}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Marginal log{-}Likelihood:  62.03 }
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toprule=.15mm, opacityback=0, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, breakable, left=2mm, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, titlerule=0mm, title={Task}, arc=.35mm, bottomrule=.15mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, toprule=.15mm, opacityback=0, leftrule=.75mm, toptitle=1mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, breakable, left=2mm, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, titlerule=0mm, title={Supplementary material: LMM as a LGM}, arc=.35mm, bottomrule=.15mm, coltitle=black]
...
\DocumentationTok{\#\# Time used:}
\DocumentationTok{\#\#     Pre = 0.286, Running = 0.251, Post = 0.139, Total = 0.677 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
\DocumentationTok{\#\# beta\_0 2.108 0.438      1.228    2.108      2.987 2.108   0}
...
Time used:
    Pre = 0.239, Running = 0.187, Post = 0.0336, Total = 0.459 
Fixed effects:
...
Intercept 1.297521 0.06488636   1.170613 1.297324    1.42555 1.297326
                   kld
Intercept 9.039192e-09
\end{verbatim}
