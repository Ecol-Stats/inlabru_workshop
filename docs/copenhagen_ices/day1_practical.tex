...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, sharp corners, colback={codebgcolor}, enhanced, frame hidden, boxrule=0pt]}{\end{tcolorbox}}\fi
\makeatother
\usepackage{bookmark}
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, left=2mm, arc=.35mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-tip-color!10!white, title={Question}, colframe=quarto-callout-tip-color-frame, toptitle=1mm, breakable, opacityback=0, coltitle=black, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, bottomrule=.15mm, colback=white, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, left=2mm, arc=.35mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colframe=quarto-callout-note-color-frame, toptitle=1mm, breakable, opacityback=0, coltitle=black, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, bottomrule=.15mm, colback=white, toprule=.15mm]
...
\DocumentationTok{\#\#     Pre = 1.22, Running = 0.213, Post = 0.0206, Total = 1.45 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean   sd 0.025quant 0.5quant 0.975quant  mode kld}
\DocumentationTok{\#\# beta\_0 2.032 0.01      2.013    2.032      2.052 2.032   0}
\DocumentationTok{\#\# beta\_1 0.484 0.01      0.465    0.484      0.503 0.484   0}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Model hyperparameters:}
\DocumentationTok{\#\#                                           mean    sd 0.025quant 0.5quant}
\DocumentationTok{\#\# Precision for the Gaussian observations 105.11 14.86      78.04   104.41}
\DocumentationTok{\#\#                                         0.975quant   mode}
\DocumentationTok{\#\# Precision for the Gaussian observations     136.21 103.01}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Marginal log{-}Likelihood:  68.41 }
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, left=2mm, arc=.35mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-warning-color!10!white, title={Task}, colframe=quarto-callout-warning-color-frame, toptitle=1mm, breakable, opacityback=0, coltitle=black, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, bottomrule=.15mm, colback=white, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, left=2mm, arc=.35mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, title={Supplementary material: LMM as a LGM}, colframe=quarto-callout-note-color-frame, toptitle=1mm, breakable, opacityback=0, coltitle=black, bottomtitle=1mm, titlerule=0mm, rightrule=.15mm, bottomrule=.15mm, colback=white, toprule=.15mm]
...
\DocumentationTok{\#\# Time used:}
\DocumentationTok{\#\#     Pre = 1.12, Running = 0.206, Post = 0.0343, Total = 1.36 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
...
Time used:
    Pre = 1.01, Running = 0.202, Post = 0.0063, Total = 1.22 
Fixed effects:
