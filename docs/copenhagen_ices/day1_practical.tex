...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, boxrule=0pt, sharp corners, breakable, enhanced, colback={codebgcolor}]}{\end{tcolorbox}}\fi
\makeatother
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, titlerule=0mm, breakable, rightrule=.15mm, toptitle=1mm, left=2mm, bottomtitle=1mm, toprule=.15mm, bottomrule=.15mm, title={Question}, leftrule=.75mm, colframe=quarto-callout-tip-color-frame, opacityback=0, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, opacitybacktitle=0.6, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, titlerule=0mm, breakable, rightrule=.15mm, toptitle=1mm, left=2mm, bottomtitle=1mm, toprule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, leftrule=.75mm, colframe=quarto-callout-note-color-frame, opacityback=0, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, colback=white]
...
\DocumentationTok{\#\#     Pre = 0.398, Running = 0.258, Post = 0.112, Total = 0.768 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean   sd 0.025quant 0.5quant 0.975quant  mode kld}
\DocumentationTok{\#\# beta\_0 1.996 0.01      1.977    1.996      2.015 1.996   0}
\DocumentationTok{\#\# beta\_1 0.483 0.01      0.464    0.483      0.502 0.483   0}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Model hyperparameters:}
\DocumentationTok{\#\#                                           mean    sd 0.025quant 0.5quant}
\DocumentationTok{\#\# Precision for the Gaussian observations 108.45 15.34      80.52   107.73}
\DocumentationTok{\#\#                                         0.975quant   mode}
\DocumentationTok{\#\# Precision for the Gaussian observations     140.53 106.28}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Marginal log{-}Likelihood:  69.97 }
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, titlerule=0mm, breakable, rightrule=.15mm, toptitle=1mm, left=2mm, bottomtitle=1mm, toprule=.15mm, bottomrule=.15mm, title={Task}, leftrule=.75mm, colframe=quarto-callout-warning-color-frame, opacityback=0, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, opacitybacktitle=0.6, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, titlerule=0mm, breakable, rightrule=.15mm, toptitle=1mm, left=2mm, bottomtitle=1mm, toprule=.15mm, bottomrule=.15mm, title={Supplementary material: LMM as a LGM}, leftrule=.75mm, colframe=quarto-callout-note-color-frame, opacityback=0, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, colback=white]
...
\DocumentationTok{\#\# Time used:}
\DocumentationTok{\#\#     Pre = 0.327, Running = 0.295, Post = 0.125, Total = 0.746 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
...
Time used:
    Pre = 0.264, Running = 0.214, Post = 0.0389, Total = 0.517 
Fixed effects:
