...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[colback={codebgcolor}, sharp corners, frame hidden, boxrule=0pt, enhanced, breakable]}{\end{tcolorbox}}\fi
\makeatother
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, leftrule=.75mm, bottomtitle=1mm, colframe=quarto-callout-tip-color-frame, opacityback=0, toprule=.15mm, rightrule=.15mm, opacitybacktitle=0.6, titlerule=0mm, title={Question}, arc=.35mm, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, toptitle=1mm, left=2mm, coltitle=black, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, leftrule=.75mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, opacityback=0, toprule=.15mm, rightrule=.15mm, opacitybacktitle=0.6, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, arc=.35mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, left=2mm, coltitle=black, breakable]
...
\DocumentationTok{\#\#     Pre = 0.483, Running = 0.235, Post = 0.224, Total = 0.941 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
\DocumentationTok{\#\# beta\_0 2.021 0.012      1.997    2.021      2.044 2.021   0}
\DocumentationTok{\#\# beta\_1 0.511 0.013      0.486    0.511      0.536 0.511   0}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Model hyperparameters:}
\DocumentationTok{\#\#                                          mean    sd 0.025quant 0.5quant}
\DocumentationTok{\#\# Precision for the Gaussian observations 72.70 10.28      53.98    72.22}
\DocumentationTok{\#\#                                         0.975quant  mode}
\DocumentationTok{\#\# Precision for the Gaussian observations      94.20 71.25}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Marginal log{-}Likelihood:  50.03 }
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, leftrule=.75mm, bottomtitle=1mm, colframe=quarto-callout-warning-color-frame, opacityback=0, toprule=.15mm, rightrule=.15mm, opacitybacktitle=0.6, titlerule=0mm, title={Task}, arc=.35mm, bottomrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, toptitle=1mm, left=2mm, coltitle=black, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, leftrule=.75mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, opacityback=0, toprule=.15mm, rightrule=.15mm, opacitybacktitle=0.6, titlerule=0mm, title={Supplementary material: LMM as a LGM}, arc=.35mm, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, left=2mm, coltitle=black, breakable]
...
\DocumentationTok{\#\# Time used:}
\DocumentationTok{\#\#     Pre = 0.31, Running = 0.31, Post = 0.171, Total = 0.791 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
...
Time used:
    Pre = 0.275, Running = 0.204, Post = 0.0434, Total = 0.522 
Fixed effects:
