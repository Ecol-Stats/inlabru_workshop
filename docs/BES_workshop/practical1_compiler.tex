...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-tip-color-frame, titlerule=0mm, opacitybacktitle=0.6, coltitle=black, toprule=.15mm, breakable, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, opacityback=0, bottomrule=.15mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, colback=white, title={Question}, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, opacitybacktitle=0.6, coltitle=black, toprule=.15mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, bottomrule=.15mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-warning-color-frame, titlerule=0mm, opacitybacktitle=0.6, coltitle=black, toprule=.15mm, breakable, left=2mm, colbacktitle=quarto-callout-warning-color!10!white, opacityback=0, bottomrule=.15mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, colback=white, title={Task}, rightrule=.15mm]
...
\DocumentationTok{\#\#     Pre = 0.486, Running = 0.236, Post = 0.216, Total = 0.938 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean   sd 0.025quant 0.5quant 0.975quant  mode kld}
\DocumentationTok{\#\# beta\_0 1.988 0.01      1.968    1.988      2.007 1.988   0}
\DocumentationTok{\#\# beta\_1 0.508 0.01      0.489    0.508      0.528 0.508   0}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Model hyperparameters:}
\DocumentationTok{\#\#                                           mean    sd 0.025quant 0.5quant}
\DocumentationTok{\#\# Precision for the Gaussian observations 105.19 14.87      78.10   104.49}
\DocumentationTok{\#\#                                         0.975quant   mode}
\DocumentationTok{\#\# Precision for the Gaussian observations     136.31 103.09}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Marginal log{-}Likelihood:  68.45 }
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, opacitybacktitle=0.6, coltitle=black, toprule=.15mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, bottomrule=.15mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Supplementary Material}, rightrule=.15mm]
...
mean       0.009698141         
sd         0.00138778          
quant0.025 0.007342559         
quant0.25  0.008708893         
quant0.5   0.009567692         
quant0.75  0.01054305          
quant0.975 0.01278428          
\end{verbatim}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, opacitybacktitle=0.6, coltitle=black, toprule=.15mm, breakable, left=2mm, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, bottomrule=.15mm, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, colback=white, title={Supplementary material: LMM as a LGM}, rightrule=.15mm]
...
\DocumentationTok{\#\# Time used:}
\DocumentationTok{\#\#     Pre = 0.317, Running = 0.296, Post = 0.172, Total = 0.784 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{practical1_compiler_files/figure-pdf/unnamed-chunk-49-1.pdf}}
\end{center}
...
Time used:
    Pre = 0.272, Running = 0.223, Post = 0.0384, Total = 0.533 
Fixed effects:
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{practical1_compiler_files/figure-pdf/unnamed-chunk-68-1.pdf}}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{practical1_compiler_files/figure-pdf/unnamed-chunk-71-1.pdf}}
\end{center}
...
Intercept 1.370605 0.05953714   1.254406 1.370335   1.488349 1.37034
                   kld
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{practical1_compiler_files/figure-pdf/unnamed-chunk-88-1.pdf}}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{practical1_compiler_files/figure-pdf/unnamed-chunk-90-1.pdf}}
\end{center}
