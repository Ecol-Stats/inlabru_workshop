...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, colback=white, coltitle=black, toprule=.15mm, breakable, arc=.35mm, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, bottomrule=.15mm, left=2mm, bottomtitle=1mm, opacitybacktitle=0.6, titlerule=0mm, title={Question}, opacityback=0, toptitle=1mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, colback=white, coltitle=black, toprule=.15mm, breakable, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, bottomrule=.15mm, left=2mm, bottomtitle=1mm, opacitybacktitle=0.6, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacityback=0, toptitle=1mm, leftrule=.75mm]
...
\DocumentationTok{\#\#     Pre = 0.522, Running = 0.226, Post = 0.085, Total = 0.833 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean   sd 0.025quant 0.5quant 0.975quant  mode kld}
\DocumentationTok{\#\# beta\_0 1.999 0.01      1.979    1.999      2.019 1.999   0}
\DocumentationTok{\#\# beta\_1 0.488 0.01      0.468    0.488      0.507 0.488   0}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Model hyperparameters:}
\DocumentationTok{\#\#                                          mean    sd 0.025quant 0.5quant}
\DocumentationTok{\#\# Precision for the Gaussian observations 98.66 13.95      73.25    98.00}
\DocumentationTok{\#\#                                         0.975quant  mode}
\DocumentationTok{\#\# Precision for the Gaussian observations     127.85 96.69}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Marginal log{-}Likelihood:  65.22 }
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-warning-color-frame, colback=white, coltitle=black, toprule=.15mm, breakable, arc=.35mm, colbacktitle=quarto-callout-warning-color!10!white, rightrule=.15mm, bottomrule=.15mm, left=2mm, bottomtitle=1mm, opacitybacktitle=0.6, titlerule=0mm, title={Task}, opacityback=0, toptitle=1mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, colback=white, coltitle=black, toprule=.15mm, breakable, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, bottomrule=.15mm, left=2mm, bottomtitle=1mm, opacitybacktitle=0.6, titlerule=0mm, title={Supplementary material: LMM as a LGM}, opacityback=0, toptitle=1mm, leftrule=.75mm]
...
\DocumentationTok{\#\# Time used:}
\DocumentationTok{\#\#     Pre = 0.307, Running = 0.26, Post = 0.152, Total = 0.719 }
\DocumentationTok{\#\# Fixed effects:}
\DocumentationTok{\#\#         mean    sd 0.025quant 0.5quant 0.975quant  mode kld}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{practical1_compiler_files/figure-pdf/unnamed-chunk-17-1.pdf}}
\end{center}
...
Time used:
    Pre = 0.262, Running = 0.21, Post = 0.0373, Total = 0.51 
Fixed effects:
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{practical1_compiler_files/figure-pdf/unnamed-chunk-25-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{practical1_compiler_files/figure-pdf/unnamed-chunk-31-1.pdf}}
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{practical1_compiler_files/figure-pdf/unnamed-chunk-33-1.pdf}}
\end{center}
