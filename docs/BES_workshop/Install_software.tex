...
\begin{verbatim}
Time used:
    Pre = 1.12, Running = 0.479, Post = 0.112, Total = 1.72 
Fixed effects:
             mean    sd 0.025quant 0.5quant 0.975quant  mode kld
(Intercept) 9.931 0.092       9.75    9.931     10.113 9.931   0

Model hyperparameters:
                                        mean    sd 0.025quant 0.5quant
Precision for the Gaussian observations 1.19 0.167      0.885     1.18
                                        0.975quant mode
Precision for the Gaussian observations       1.54 1.17

Marginal log-Likelihood:  -145.95 
 is computed 
...
Time used:
    Pre = 0.788, Running = 0.499, Post = 0.168, Total = 1.45 
Fixed effects:
           mean    sd 0.025quant 0.5quant 0.975quant  mode kld
Intercept 9.931 0.092       9.75    9.931     10.113 9.931   0
...
Marginal log-Likelihood:  -150.41 
 is computed 
Posterior summaries for the linear predictor and the fitted values are computed
(Posterior marginals needs also 'control.compute=list(return.marginals.predictor=TRUE)')
\end{verbatim}
