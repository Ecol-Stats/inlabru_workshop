...
\begin{verbatim}
Time used:
    Pre = 0.419, Running = 0.227, Post = 0.0516, Total = 0.697 
Fixed effects:
            mean    sd 0.025quant 0.5quant 0.975quant mode kld
(Intercept)   10 0.097      9.809       10     10.191   10   0

Model hyperparameters:
                                        mean    sd 0.025quant 0.5quant
Precision for the Gaussian observations 1.08 0.152      0.803     1.07
                                        0.975quant mode
Precision for the Gaussian observations       1.40 1.06

Marginal log-Likelihood:  -150.84 
 is computed 
...
Time used:
    Pre = 0.279, Running = 0.23, Post = 0.069, Total = 0.578 
Fixed effects:
          mean    sd 0.025quant 0.5quant 0.975quant mode kld
Intercept   10 0.097      9.809       10      10.19   10   0
...
Marginal log-Likelihood:  -155.31 
 is computed 
Posterior summaries for the linear predictor and the fitted values are computed
(Posterior marginals needs also 'control.compute=list(return.marginals.predictor=TRUE)')
\end{verbatim}
