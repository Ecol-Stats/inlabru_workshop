...
\begin{verbatim}
Time used:
    Pre = 0.422, Running = 0.246, Post = 0.0448, Total = 0.712 
Fixed effects:
            mean    sd 0.025quant 0.5quant 0.975quant mode kld
(Intercept)  9.9 0.098      9.708      9.9     10.092  9.9   0

Model hyperparameters:
                                        mean    sd 0.025quant 0.5quant
Precision for the Gaussian observations 1.06 0.149       0.79     1.05
                                        0.975quant mode
Precision for the Gaussian observations       1.38 1.04

Marginal log-Likelihood:  -151.67 
 is computed 
...
Time used:
    Pre = 0.283, Running = 0.223, Post = 0.0695, Total = 0.576 
Fixed effects:
          mean    sd 0.025quant 0.5quant 0.975quant mode kld
Intercept  9.9 0.098      9.708      9.9     10.092  9.9   0
...
Marginal log-Likelihood:  -156.14 
 is computed 
Posterior summaries for the linear predictor and the fitted values are computed
(Posterior marginals needs also 'control.compute=list(return.marginals.predictor=TRUE)')
\end{verbatim}
