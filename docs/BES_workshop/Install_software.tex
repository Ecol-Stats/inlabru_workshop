...
\begin{verbatim}
Time used:
    Pre = 0.426, Running = 0.233, Post = 0.0557, Total = 0.714 
Fixed effects:
             mean    sd 0.025quant 0.5quant 0.975quant  mode kld
(Intercept) 9.902 0.098      9.709    9.902     10.094 9.902   0

Model hyperparameters:
                                        mean    sd 0.025quant 0.5quant
Precision for the Gaussian observations 1.06 0.149      0.785     1.05
                                        0.975quant mode
Precision for the Gaussian observations       1.37 1.03

Marginal log-Likelihood:  -151.97 
 is computed 
...
Time used:
    Pre = 0.276, Running = 0.24, Post = 0.062, Total = 0.579 
Fixed effects:
           mean    sd 0.025quant 0.5quant 0.975quant  mode kld
Intercept 9.901 0.098      9.709    9.901     10.094 9.901   0
...
Marginal log-Likelihood:  -156.43 
 is computed 
Posterior summaries for the linear predictor and the fitted values are computed
(Posterior marginals needs also 'control.compute=list(return.marginals.predictor=TRUE)')
\end{verbatim}
