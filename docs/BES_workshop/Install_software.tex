...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, sharp corners, colback={codebgcolor}, frame hidden, boxrule=0pt, breakable]}{\end{tcolorbox}}\fi
\makeatother
...
\begin{verbatim}
Time used:
    Pre = 0.433, Running = 0.23, Post = 0.0553, Total = 0.718 
Fixed effects:
             mean    sd 0.025quant 0.5quant 0.975quant  mode kld
(Intercept) 10.16 0.107       9.95    10.16     10.371 10.16   0

Model hyperparameters:
                                         mean    sd 0.025quant 0.5quant
Precision for the Gaussian observations 0.882 0.124      0.656    0.876
                                        0.975quant  mode
Precision for the Gaussian observations       1.14 0.865

Marginal log-Likelihood:  -161.06 
 is computed 
...
Time used:
    Pre = 0.302, Running = 0.241, Post = 0.0774, Total = 0.621 
Fixed effects:
           mean    sd 0.025quant 0.5quant 0.975quant  mode kld
Intercept 10.16 0.107       9.95    10.16     10.371 10.16   0
...
Marginal log-Likelihood:  -165.52 
 is computed 
Posterior summaries for the linear predictor and the fitted values are computed
(Posterior marginals needs also 'control.compute=list(return.marginals.predictor=TRUE)')
\end{verbatim}
