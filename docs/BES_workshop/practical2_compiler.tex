...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, frame hidden, breakable, boxrule=0pt, enhanced, colback={codebgcolor}]}{\end{tcolorbox}}\fi
\makeatother
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, titlerule=0mm, coltitle=black, breakable, colframe=quarto-callout-note-color-frame, colback=white, rightrule=.15mm, left=2mm, opacitybacktitle=0.6, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, toprule=.15mm, arc=.35mm, toptitle=1mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, titlerule=0mm, coltitle=black, breakable, colframe=quarto-callout-warning-color-frame, colback=white, rightrule=.15mm, left=2mm, opacitybacktitle=0.6, bottomrule=.15mm, title={Task}, toprule=.15mm, arc=.35mm, toptitle=1mm, opacityback=0]
...
: ::: \{.callout-tip icon=``false''\} \#\# Question
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, left=2mm, leftrule=.75mm, bottomrule=.15mm, arc=.35mm, breakable, toprule=.15mm, opacityback=0, colframe=quarto-callout-note-color-frame, colback=white]
