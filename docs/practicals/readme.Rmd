...
=======
|------------------|------------------|-------------------|------------------|
>>>>>>> cb2855d1a79c3f229b4a68226d55fc3e1edc4913
...
<<<<<<< HEAD
=======
| Ar1_ex.qmd | AR(1) Model | fitting ar1 model, predicting the mean and forecasting. | Simulated Data |
| Ar1_Rw1_ex.qmd | AR(1) and RW(1-2) Models | fitting an ar and rw models, change prior for Gaussian error and set PC prior for correlation parameter. add group-level correlation and fit a model to non-Gaussian data | Real Data - water height levels in `greatlakes` dataset from `DAAG` library and `Tokyo` rainfall data |
>>>>>>> cb2855d1a79c3f229b4a68226d55fc3e1edc4913
