...
Consider the `pcod_sf`, the spatial extension and type of the data...is some of the previous choices more reasonable than other? `mcq(c("spde_model1","spde_model2", answer = "spde_model3"))`
