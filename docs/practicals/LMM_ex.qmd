...
The group variable is indexed by column `j` in the dataset. We have chosen to name this component `u()` to connect with the mathematical notation that we used above.
